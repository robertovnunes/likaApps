...
.myPosition {
	...
	<div id="container" style="margin-top: 30px;"><h:form
		...
		<h:commandButton value="Cadastro da Publicação"
			rendered="#{sessionHandler.navigation.mostrarVisualizarPeriodico}"
			actionListener="#{relatorioHandler.gerarCadastroPeriodico}">
		...
		<h:panelGroup
			...
			<div align="right" style="margin-top: 20px;"><h:commandButton
				value="Voltar" action="pesquisarPeriodico" /> <h:commandButton
				value="Editar" action="#{sessionHandler.navigation.editarPeriodico}">
		...
		<h:panelGroup
			rendered="#{sessionHandler.navigation.mostrarEditarPeriodico}">
			<div align="right" style="margin-top: 20px;"><h:commandButton
		...
		<f:subview id="editarPeriodico"
			rendered="#{sessionHandler.navigation.mostrarEditarPeriodico}">
			<jsp:include page="/periodico/editarPeriodico.jsp"></jsp:include>
		</f:subview>

		<f:subview id="visualizarPeriodico"
			rendered="#{sessionHandler.navigation.mostrarVisualizarPeriodico}">
			<jsp:include page="/periodico/visualizarPeriodico.jsp"></jsp:include>
		</f:subview>
