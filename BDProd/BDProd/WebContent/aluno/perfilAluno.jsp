	...
	<div id="container" style="margin-top: 30px;"><h:form
		...
		<h:panelGroup
			...
			<div align="right" style="margin-top: 20px;"><h:commandButton
				value="Voltar" action="pesquisarAluno" /> <h:commandButton
		...
		<h:panelGroup
			...
			<h:commandButton value="Tornar Pesquisador" action="#{alunoHandler.tornarPesquisador}"
				onclick="if (!confirm('Confirma a conversão deste aluno para pesquisador? A ficha deste aluno será removida.')) return false"
