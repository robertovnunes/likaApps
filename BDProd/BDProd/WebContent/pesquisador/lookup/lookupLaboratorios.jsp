...
<f:subview id="lookupLaboratorios">
	...
	<!-- ui-dialog -->
	<div id="dialogLaboratorios"
		title="Associar Laboratório ao Pesquisador"><h:form
		styleClass="niceform">
			...
			<rich:dataTable id="tabelaResultadoLab"
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true"
						onclick="jQuery('#dialogLaboratorios').dialog('close')"
						value="Selecionar" reRender="panelLaboratorios"
						actionListener="#{pesquisadorHandler.adicionarLaboratorio}">
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			columns="2">
				...
				<a4j:commandLink onclick="jQuery('#dialogLaboratorios').dialog('close')">
