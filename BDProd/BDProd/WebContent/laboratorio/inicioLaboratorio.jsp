...
<f:view>
	...
	<div id="page"><h:form>
		...
		<ul>
			...
			<h2>Opções</h2>
			<ul>
				<li><h:commandLink value="Novo Laboratório"
					action="#{sessionHandler.navigation.novoLab}"
					actionListener="#{laboratorioHandler.novoLaboratorio}" /></li>
			</ul>
			</li>
		</ul>
		</div>
		...
		<div id="content"><a4j:region id="regiao">
			...
			<h:panelGroup id="campo">
				...
				<h:inputText id="textBuscaNome" style="width: 400px"
					value="#{laboratorioHandler.parametroPesquisa}" />


				<a4j:commandButton id="botaoBuscar" value="Buscar"
					action="#{laboratorioHandler.consultar}" reRender="panel"
					onclick="this.disabled=true" oncomplete="this.disabled=false" />


			</h:panelGroup> <h:selectOneRadio value="#{laboratorioHandler.tipoSelecionado}">
				<f:selectItems value="#{laboratorioHandler.tiposDePesquisas}" />
				<a4j:support reRender="campo" event="onclick"
					action="#{laboratorioHandler.limparConsulta}" ajaxSingle="true" />
			</h:selectOneRadio></div>

			<a4j:outputPanel id="panel">

				<h:panelGroup rendered="#{empty laboratorioHandler.laboratorios }">
					<div id="nenhum" align="center" style="color: red;"><h:outputText
						value="Nenhum Laboratório econtrado. " /></div>
				</h:panelGroup>
				...
				<h:panelGroup
					rendered="#{not empty laboratorioHandler.laboratorios }">
					<div class="titulo" style="margin-left: 15px; margin-bottom: 15px">
					<h:outputText value="Laboratório" /></div>

					<div style="margin-left: 10px;"><rich:dataTable
						id="tabelaResultado" value="#{laboratorioHandler.laboratorios}"
						var="laboratorio" cellpadding="2" cellspacing="2"
						...
						<rich:column id="nome">
							...
							<div style="width: 420px"><h:outputText
								value="#{laboratorio.nome}"></h:outputText></div>
						</rich:column>
						...
						<rich:column id="opcoes">
							...
							<h:commandLink 
								action="#{sessionHandler.navigation.visualizarLab}"
								actionListener="#{laboratorioHandler.carregarLaboratorio}">
								<f:attribute name="idLaboratorio"
									value="#{laboratorio.idLaboratorio}" />


								<h:graphicImage value="../images/editar4.png"
									style="border:none;" title="Editar Laboratório"
									alt="Editar Laboratório" width="17" height="17"></h:graphicImage>
