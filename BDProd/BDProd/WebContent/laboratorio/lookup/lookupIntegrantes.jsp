...
<f:subview id="lookupIntegrantes">
	...
	<div id="dialogIntegrantes"
		title="Associar um Integrante ao Laboratório"><h:form
		styleClass="niceform">
			...
			<rich:dataTable id="tabelaResultadoIntegrante"
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						...
						value="Selecionar" reRender="panelIntegrantes"
						actionListener="#{laboratorioHandler.adicionarIntegrante}">
						<f:attribute value="#{pessoa}" name="pessoa" />
					</a4j:commandLink></div>
				</rich:column>
