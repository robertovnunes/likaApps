...
<f:subview id="lookupProjeto">
	...
	<!-- ui-dialog -->
	<div id="dialogProjeto" title="Associar Projeto ao Grupo de Pesquisa"><h:form
		styleClass="niceform">
			...
			<rich:dataTable id="tabelaResultadoProj"
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true"
						onclick="jQuery('#dialogProjeto').dialog('close')" oncomplete="#{rich:component('dsProjetos')}.last()"
						value="Selecionar" reRender="projetos"
						actionListener="#{grupoHandler.adicionarProjeto}">
						<f:attribute value="#{proj}" name="projeto" />
					</a4j:commandLink></div>
				</rich:column>
