...
.myPosition {
	...
	<div id="container" style="margin-top: 30px;"><h:form
		...
		<h:panelGroup
			rendered="#{sessionHandler.navigation.mostrarVisualizarDepartamento}">
			<div align="right" style="margin-top: 20px;"><h:commandButton
				value="Voltar" action="pesquisarDepartamento" /> <h:commandButton
				value="Editar"
				action="#{sessionHandler.navigation.editarDepartamento}">

			</h:commandButton></div>
		</h:panelGroup>

		<h:panelGroup
			rendered="#{sessionHandler.navigation.mostrarEditarDepartamento}">
			<div align="right" style="margin-top: 20px;"><h:commandButton
				value="Cancelar" action="#{adminHandler.refreshDepartamento}"
				immediate="true" /> <h:commandButton value="Salvar"
				action="#{adminHandler.salvarDepartamento}">

			</h:commandButton></div>
		</h:panelGroup>


		<f:subview id="editarDepartamento"
			rendered="#{sessionHandler.navigation.mostrarEditarDepartamento}">
			<jsp:include page="/administracao/editarDepartamento.jsp"></jsp:include>
		</f:subview>

		<f:subview id="visualizarDepartamento"
			rendered="#{sessionHandler.navigation.mostrarVisualizarDepartamento}">
			<jsp:include page="/administracao/visualizarDepartamento.jsp"></jsp:include>
		</f:subview>
