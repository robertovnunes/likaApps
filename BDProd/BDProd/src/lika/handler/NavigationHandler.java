...
public class NavigationHandler {
	...
	public String inicioLab() {
		...
		this.localizacao = "Listar Laboratórios";
	...
	public String inicioPeriodico() {
		...
		this.localizacao = "Listar Periódicos";
	...
	public String inicioRelatoriosPublicacao() {
		this.localizacao = "Relatórios das Publicações";
		return "relatorioPublicacoes";
	}

	public String inicioRelatoriosProjeto() {
		this.localizacao = "Relatórios dos Projetos";
		return "relatorioProjetos";
	}

	public String inicioRelatoriosAluno() {
		this.localizacao = "Relatórios dos Alunos";
		return "relatorioAlunos";
	}
	
	public String inicioRelatoriosAlunosAtivos() {
		this.localizacao = "Relatórios dos Alunos Resumido";
		return "relatorioAlunosAtivos";
	}
	...
	public String visualizarUsuario() {
		...
		this.localizacao = "Usuário";
		return "visualizarUsuario";
	}

	public String editarUsuario() {
		this.acaoAtual = AcaoAtual.Editar_Usuario;
		this.localizacao = "Editar Usuário";
		return "editarUsuario";
	}

	public String novoUsuario() {
		this.acaoAtual = AcaoAtual.Editar_Usuario;
		this.localizacao = "Novo Usuário";
	...
	public String inicioUsuario() {
		...
		this.localizacao = "Listar Usuários";
	...
	public String inicioFuncao() {
		...
		this.localizacao = "Listar Função";
