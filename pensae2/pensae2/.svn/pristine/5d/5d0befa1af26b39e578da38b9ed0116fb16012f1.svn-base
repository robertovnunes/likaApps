    ...
    <div id="middle">    
		<div id="middle_align">
            ...
            <div class="col w75">
               ...
               <p>Olá, este é o software PenSAE, um ambiente de aprendizagem interativa, que utiliza a metodologia da problematização para a construção do conhecimento aplicado ao Processo de Enfermagem no cuidado à saúde da criança. O Processo de Enfermagem é um conjunto de ações direcionadas à solução de problemas, onde o enfermeiro planeja, implementa e avalia as atividades de Enfermagem. Através deste software você terá a oportunidade de desenvolver competências e habilidades essenciais para o exercício prático do Processo de Enfermagem, adquirindo autonomia e confiança para a tomada de decisão clínica.</p>
            </div>
