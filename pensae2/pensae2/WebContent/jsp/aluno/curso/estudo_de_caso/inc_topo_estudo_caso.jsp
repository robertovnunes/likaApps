...
<div class="rf-tab-hdr-tabline-vis rf-tab-hdr-tabline-top">
    <table cellspacing="0" class="rf-tab-hdr-tabs">
        ...
        <td style="" class="rf-tab-hdr rf-tab-hdr-act rf-tab-hdr-top" id="j_idt2345:j_idt2347:header:active"><span class="rf-tab-lbl">
        	...
        	<a href="estudoCaso.do?method=mostrarTelaObservacaoRealidade&idEstudoCaso=${ estudoDeCaso.id}">Observação da Realidade</a></span></td>
        ...
        <a href="ptsChave.do?method=mostrarTelaPontosChave"> Pontos-Chaves</a></span></td>
        <td class="rf-tab-hdr-spcr rf-tab-hortab-tabspcr-wdh" style=""><br></td>
       ...
       <c:if test="${arcoMaguerez.faseDoArco < 2}">
        ...
        <a href="teorizacao.do?method=mostrarTelaTeorizacao">Teorização</a></span></td>
        <td class="rf-tab-hdr-spcr rf-tab-hortab-tabspcr-wdh" style=""><br></td>
        ...
        <a href="hipoteses.do?method=mostrarTelaHipoteses">Hipóteses de Solução</a></span></td>
        <td class="rf-tab-hdr-spcr rf-tab-hortab-tabspcr-wdh" style=""><br></td>
        ...
        <a href="aplicacao.do?method=mostrarTelaAplicacao">Aplicação à Realidade</a></span></td>
