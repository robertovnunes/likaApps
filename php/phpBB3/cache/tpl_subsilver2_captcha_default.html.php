<?php if (!defined('IN_PHPBB')) exit; ?><tr>
	...
	<tr>
		...
		<?php if ($this->_rootref['S_CONFIRM_REFRESH']) {  ?><input type="submit" name="refresh_vc" id="refresh_vc" class="button2" value="<?php echo ((isset($this->_rootref['L_VC_REFRESH'])) ? $this->_rootref['L_VC_REFRESH'] : ((isset($user->lang['VC_REFRESH'])) ? $user->lang['VC_REFRESH'] : '{ VC_REFRESH }')); ?>" /><?php } ?></td>
	</tr>