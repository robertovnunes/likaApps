<?php if (!defined('IN_PHPBB')) exit; ?><tr>
	...
	<tr>
		<td class="row3h" colspan="2"><span class="gensmall"><?php echo ((isset($this->_rootref['L_CONFIRM_EXPLAIN'])) ? $this->_rootref['L_CONFIRM_EXPLAIN'] : ((isset($user->lang['CONFIRM_EXPLAIN'])) ? $user->lang['CONFIRM_EXPLAIN'] : '{ CONFIRM_EXPLAIN }')); ?></span></td>
	</tr>
	<tr>
