...
<?php } if ($this->_rootref['S_SHOW_DRAFTS']) {  ?>
	...
	<tr>
		<td class="row3h" colspan="3" align="center"><span class="gen"><?php echo ((isset($this->_rootref['L_LOAD_DRAFT_EXPLAIN'])) ? $this->_rootref['L_LOAD_DRAFT_EXPLAIN'] : ((isset($user->lang['LOAD_DRAFT_EXPLAIN'])) ? $user->lang['LOAD_DRAFT_EXPLAIN'] : '{ LOAD_DRAFT_EXPLAIN }')); ?></span></td>
	</tr>
	<tr>
...
<?php if ($this->_rootref['ERROR']) {  ?>
	<tr>
		<td class="row3h" colspan="2" align="center"><span class="genmed error"><?php echo (isset($this->_rootref['ERROR'])) ? $this->_rootref['ERROR'] : ''; ?></span></td>
	</tr>
...
<?php } if ($this->_rootref['S_PRIVMSGS']) {  ?>
	<tr>
		...
		<?php $_to_recipient_count = (isset($this->_tpldata['to_recipient'])) ? sizeof($this->_tpldata['to_recipient']) : 0;if ($_to_recipient_count) {for ($_to_recipient_i = 0; $_to_recipient_i < $_to_recipient_count; ++$_to_recipient_i){$_to_recipient_val = &$this->_tpldata['to_recipient'][$_to_recipient_i]; ?>
			...
			<?php if ($_to_recipient_val['IS_GROUP']) {  ?><a href="<?php echo $_to_recipient_val['U_VIEW']; ?>"><span class="sep"><?php echo $_to_recipient_val['NAME']; ?></span></a><?php } else { echo $_to_recipient_val['NAME_FULL']; } ?></strong>&nbsp;<?php if (! $this->_rootref['S_EDIT_POST']) {  ?><input class="btnmain" type="submit" name="remove_<?php echo $_to_recipient_val['TYPE']; ?>[<?php echo $_to_recipient_val['UG_ID']; ?>]" value="<?php echo ((isset($this->_rootref['L_REMOVE'])) ? $this->_rootref['L_REMOVE'] : ((isset($user->lang['REMOVE'])) ? $user->lang['REMOVE'] : '{ REMOVE }')); ?>" />&nbsp;<?php } ?>
			</span>
		<?php }} else { ?>
	...
	<tr>
		...
		<?php $_bcc_recipient_count = (isset($this->_tpldata['bcc_recipient'])) ? sizeof($this->_tpldata['bcc_recipient']) : 0;if ($_bcc_recipient_count) {for ($_bcc_recipient_i = 0; $_bcc_recipient_i < $_bcc_recipient_count; ++$_bcc_recipient_i){$_bcc_recipient_val = &$this->_tpldata['bcc_recipient'][$_bcc_recipient_i]; ?>
			...
			<?php if ($_bcc_recipient_val['IS_GROUP']) {  ?><a href="<?php echo $_bcc_recipient_val['U_VIEW']; ?>"><span class="sep"><?php echo $_bcc_recipient_val['NAME']; ?></span></a><?php } else { echo $_bcc_recipient_val['NAME_FULL']; } ?></strong>&nbsp;<?php if (! $this->_rootref['S_EDIT_POST']) {  ?><input class="btnmain" type="submit" name="remove_<?php echo $_bcc_recipient_val['TYPE']; ?>[<?php echo $_bcc_recipient_val['UG_ID']; ?>]" value="<?php echo ((isset($this->_rootref['L_REMOVE'])) ? $this->_rootref['L_REMOVE'] : ((isset($user->lang['REMOVE'])) ? $user->lang['REMOVE'] : '{ REMOVE }')); ?>" />&nbsp;<?php } ?>
			</span>
		<?php }} else { ?>
...
<tr>
	<td class="catb" colspan="2" align="center"><?php echo (isset($this->_rootref['S_HIDDEN_FIELDS'])) ? $this->_rootref['S_HIDDEN_FIELDS'] : ''; ?>
