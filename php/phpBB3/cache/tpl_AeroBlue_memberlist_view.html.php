...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<tr>
		<td class="row3h" width="40%" align="center"><?php echo ((isset($this->_rootref['L_USER_PRESENCE'])) ? $this->_rootref['L_USER_PRESENCE'] : ((isset($user->lang['USER_PRESENCE'])) ? $user->lang['USER_PRESENCE'] : '{ USER_PRESENCE }')); ?></td>
		<td class="row3h" width="60%" align="center"><?php echo ((isset($this->_rootref['L_USER_FORUM'])) ? $this->_rootref['L_USER_FORUM'] : ((isset($user->lang['USER_FORUM'])) ? $user->lang['USER_FORUM'] : '{ USER_FORUM }')); ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="row3h" align="center"><?php echo ((isset($this->_rootref['L_CONTACT_USER'])) ? $this->_rootref['L_CONTACT_USER'] : ((isset($user->lang['CONTACT_USER'])) ? $user->lang['CONTACT_USER'] : '{ CONTACT_USER }')); ?></td>
		<td class="row3h" align="center"><?php echo ((isset($this->_rootref['L_ABOUT_USER'])) ? $this->_rootref['L_ABOUT_USER'] : ((isset($user->lang['ABOUT_USER'])) ? $user->lang['ABOUT_USER'] : '{ ABOUT_USER }')); ?></td>
	</tr>
	<tr>
		<td class="row1">
			<table width="100%" cellspacing="5" cellpadding="2" border="0">
		...
		<td class="row1">
			...
			<tr>
				...
				<td><b class="genmed"><?php if ($this->_rootref['AGE']) {  ?>&nbsp;<?php echo (isset($this->_rootref['AGE'])) ? $this->_rootref['AGE'] : ''; } else { ?> - <?php } ?></b></td>
			</tr>
			<?php } ?>
			<tr>
