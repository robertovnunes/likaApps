...
<tr>
	<td class="row3h" colspan="2"><span class="gensmall"><?php echo ((isset($this->_rootref['L_ADD_POLL_EXPLAIN'])) ? $this->_rootref['L_ADD_POLL_EXPLAIN'] : ((isset($user->lang['ADD_POLL_EXPLAIN'])) ? $user->lang['ADD_POLL_EXPLAIN'] : '{ ADD_POLL_EXPLAIN }')); ?></span></td>
</tr>
<tr>
...
<tr>
	...
	<td class="row2"><textarea class="post" style="width:450px" name="poll_option_text" rows="5" cols="35"><?php echo (isset($this->_rootref['POLL_OPTIONS'])) ? $this->_rootref['POLL_OPTIONS'] : ''; ?></textarea></td>
</tr>
<tr>
