...
<?php if ($this->_rootref['LOGIN_EXPLAIN'] && ! $this->_rootref['S_ADMIN_AUTH']) {  ?>
	<tr>
		<td class="row3h" colspan="2" align="center"><span class="gensmall"><?php echo (isset($this->_rootref['LOGIN_EXPLAIN'])) ? $this->_rootref['LOGIN_EXPLAIN'] : ''; ?></span></td>
	</tr>
<?php } if (! $this->_rootref['S_ADMIN_AUTH']) {  ?>
	...
	<td <?php if (! $this->_rootref['S_ADMIN_AUTH']) {  ?>class="row2"<?php } else { ?>class="row1"<?php } ?>>
		...
		<tr>
			<td valign="top" <?php if ($this->_rootref['S_ADMIN_AUTH']) {  ?>style="width: 45%; text-align: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;"<?php } ?>><b class="gensmall"><?php echo ((isset($this->_rootref['L_USERNAME'])) ? $this->_rootref['L_USERNAME'] : ((isset($user->lang['USERNAME'])) ? $user->lang['USERNAME'] : '{ USERNAME }')); ?>:</b></td>
		...
		<tr>
			<td valign="top" <?php if ($this->_rootref['S_ADMIN_AUTH']) {  ?>style="width: 45%; text-align: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;"<?php } ?>><b class="gensmall"><?php echo ((isset($this->_rootref['L_PASSWORD'])) ? $this->_rootref['L_PASSWORD'] : ((isset($user->lang['PASSWORD'])) ? $user->lang['PASSWORD'] : '{ PASSWORD }')); ?>:</b></td>
			<td>
