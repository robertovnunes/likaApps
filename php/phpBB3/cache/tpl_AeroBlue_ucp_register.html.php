...
<?php if ($this->_rootref['L_REG_COND']) {  ?>
	<tr>
		<td class="row3h" colspan="2"><span class="gensmall"><?php echo ((isset($this->_rootref['L_REG_COND'])) ? $this->_rootref['L_REG_COND'] : ((isset($user->lang['REG_COND'])) ? $user->lang['REG_COND'] : '{ REG_COND }')); ?></span></td>
	</tr>
<?php } if ($this->_rootref['ERROR']) {  ?>
	<tr>
		<td class="row1" colspan="2" align="center"><span class="gensmall error"><?php echo (isset($this->_rootref['ERROR'])) ? $this->_rootref['ERROR'] : ''; ?></span></td>
	</tr>
<?php } ?>
