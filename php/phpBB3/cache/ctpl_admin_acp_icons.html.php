	...
	<tr class="row1">
		...
		<td><input type="checkbox" class="radio" name="add_display_on_posting" checked="checked" onclick="toggle_select('add', this.checked, 'add_order');"/></td>
 		<td><select id="add_order" name="add_order">
				<optgroup id="order_disp[add]" label="<?php echo ((isset($this->_rootref['L_DISPLAY_POSTING'])) ? $this->_rootref['L_DISPLAY_POSTING'] : ((isset($user->lang['DISPLAY_POSTING'])) ? $user->lang['DISPLAY_POSTING'] : '{ DISPLAY_POSTING }')); ?>"><?php echo (isset($this->_rootref['S_ADD_ORDER_LIST_DISPLAY'])) ? $this->_rootref['S_ADD_ORDER_LIST_DISPLAY'] : ''; ?></optgroup>
				<optgroup id="order_no_disp[add]" label="<?php echo ((isset($this->_rootref['L_DISPLAY_POSTING_NO'])) ? $this->_rootref['L_DISPLAY_POSTING_NO'] : ((isset($user->lang['DISPLAY_POSTING_NO'])) ? $user->lang['DISPLAY_POSTING_NO'] : '{ DISPLAY_POSTING_NO }')); ?>" disabled="disabled" class="disabled-options" ><?php echo (isset($this->_rootref['S_ADD_ORDER_LIST_UNDISPLAY'])) ? $this->_rootref['S_ADD_ORDER_LIST_UNDISPLAY'] : ''; ?></optgroup>
		</select></td>
