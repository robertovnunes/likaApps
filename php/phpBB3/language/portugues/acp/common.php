...
$lang = array_merge($lang, array(
	...
	'SHOW_ALL_OPERATIONS'	=> 'Mostrar todas opera&ccedil;&otilde;es',
	'ACP_CAPTCHA'				=> 'CAPTCHA',
	...
	'ACP_FORUM_PERMISSIONS_COPY'	=> 'Copiar permiss&otilde;es de F&oacute;rum',
	...
	'ACP_FEED_SETTINGS'			=> 'Op&ccedil;&otilde;es Feed',
	...
	'ACP_SEND_STATISTICS'		=> 'Enviar informa&ccedil;&atilde;o de estat&iacute;stica',
	...
	'ACP_STYLES'				=> 'Estilos',
	'ACP_SUBMIT_CHANGES'		=> 'Enviar mudan&ccedil;as',
	...
	'ACP_VC_SETTINGS'					=> 'CAPTCHA op&ccedil;&otilde;es de m&oacute;dulo',
...
// Mudan�as 3.0.5
	...
	'MORE_INFORMATION'		=> 'Mais informa&ccedil;&otilde;es �',
	...
	'PERMISSIONS_TRANSFERRED'			=> 'Transfer&ecirc;ncia de permiss&atilde;o',
	'PERMISSIONS_TRANSFERRED_EXPLAIN'   => 'Voc&ecirc; tem as permiss&otilde;es atuais de %1$s. Voc&ecirc; est&aacute; apto para navegar na comunidade com estas permiss&otilde;es de usu&aacute;rio, mas n&atilde;o para acessar o painel administrativo desde que as permiss&otilde;es administrativas n&atilde;o foram transferidas. Voc&ecirc; pode <a href="%2$s"><strong>reverter para suas permiss&otilde;es originais</strong></a> a qualquer momento.',
...
$lang = array_merge($lang, array(
	...
	'PHP_VERSION_OLD'	=> 'A vers&atilde;o do PHP deste servidor n&atilde;o ser&aacute; mais suportada pelo phpBB. %sDetalhes%s',
    ...
    'PURGE_CACHE_EXPLAIN'   => 'Esta a&ccedil;&atilde;o ir&aacute; liberar todo o cache da comunidade, esta a&ccedil;&atilde;o pode deixar a comunidade lenta at&eacute; recuperar o cache novamente',
    	'PURGE_SESSIONS'			=> 'Remover todas as sess&otilde;es',
	'PURGE_SESSIONS_CONFIRM'	=> 'Voce tem certeza que deseja remover todas as sess&otilde;es? Isto ir&aacute; deslogar todos os membros ativos no momento.',
	'PURGE_SESSIONS_EXPLAIN'	=> 'Remover todas as sess&otilde;es. Isto ir&aacute; deslogar todos os usur&aacute;rios por limpar a tabela de sess&atilde;o da comunidade.',
	...
	'VALUE'					=> 'Valor',
	'VERSIONCHECK_FAIL'			=> 'Falha ao tentar obter a &uacute;ltima vers&atilde;o dispon&iacute;vel.',
	'VERSIONCHECK_FORCE_UPDATE'	=> 'Re-Checar vers&atilde;o',
...
'SORT_LAST_REMINDER'=> '&Uacute;ltimo lembrado',
...
$lang = array_merge($lang, array(
	...
	'LOG_FORUM_COPIED_PERMISSIONS'			=> '<strong>permiss&otilde;es de f&oacute;rum copiadas</strong> de %1$s<br />� %2$s',
	...
	'LOG_PURGE_SESSIONS'		=> '<strong>Removido sess&otilde;es</strong>',
	...
	'LOG_WARNINGS_DELETED'		=> '<strong>Removido %2$s avisos de usu&aacute;rio</strong><br />� %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />� username'
	'LOG_WARNINGS_DELETED_ALL'	=> '<strong>Removido todos os avisos do usu&aacute;rio</strong><br />� %s',
