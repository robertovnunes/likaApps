...
$lang = array_merge($lang, array(
	...
	'ALLOW_PM_REPORT'			=> 'Permitir usu&aacute;rios reportarem mensagem privada',
	'ALLOW_PM_REPORT_EXPLAIN'	=> 'Se esta op&ccedil;&atilde;o est&aacute; ativa, usu&aacute;rios poder&atilde;o reportar as mensagens privadas que receberem para os moderadores. A mensagem privada ent&atilde;o poder&acute; ser vista pelo moderador no painel de modera&ccedil;&atilde;o.',
	'ALLOW_QUICK_REPLY'			=> 'Permitir resposta r&atilde;pida',
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'Esta op&ccedil;&atilde;o define se resposta r&aacute;pida estar&aacute; habilitada ou n&atilde;o. Se isto estiver habilitado o f&oacute;rum dever&aacute; ter a op&ccedil;&atilde;o de resposta r&aacute;pida habilitada tamb&eacute;m.',
	'ALLOW_QUICK_REPLY_BUTTON'	=> 'Enviar e habilitar resposta r&aacute;pida em todos os f&oacute;runs',
...
'ALLOW_AVATARS'					=> 'Habilitar avatares',
	'ALLOW_AVATARS_EXPLAIN'			=> 'Permite uso geral de avatares;<br />Se voce desabilitar em geral ou apenas avatares de certos modos, o avatar desabilitado n&atilde;o ser&aacute; mais mostrado no f&oacute;rum, mas usu&aacute;rios ainda poder&atilde;o fazer download de seus avatares no painel de controle dos usu&aacute;rios.',
...
$lang = array_merge($lang, array(
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'N&uacute;mero em minutos, horas ou dias entre a &uacute;ltima mensagem para um t&oacute;pico e a habilidade de pular este t&oacute;pico para cima. Deixando com 0 desabilita esta op&ccedil;&atilde;o.',
	...
	'DELETE_TIME_EXPLAIN'			=> 'Limita o tempo dispon&iacute;vel para deletar uma nova mensagem. Deixando o valor como 0 ir&aacute; desabilitar esta op&ccedil;&atilde;o',
	...
	'MIN_CHAR_LIMIT'				=> 'M&iacute;nimo de caracteres permitidos na mensagem',
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'N&uacute;mero m&iacute;nimo de caracteres a serem escritos numa mensagem a ser adicionada ao f&oacute;rum ou privada.',
	'POSTING'						=> 'Mensagem',
	...
	'SMILIES_PER_PAGE'				=> 'Smilies por p&aacute;gina',
));
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Novos membros s&atilde;o <em>Rec&eacute;m Registrados (Novatos)</em> grupo at&eacute; eles alcan&ccedil;arem este n&uacute;mero de mensagens. Voce pode usar este grupo para evitar que eles fiquem usando o sistema de mensagem particular ou editar suas mensagens. <strong>O valor de 0 desabilita esta op&ccedil;&atilde;o.</strong>',
	'NEW_MEMBER_GROUP_DEFAULT'		=> 'Define Rec&eacute; Registrados grupo como padr&atilde;o',
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Se definido como SIM e um valor de mensagens limite especificado, novos usu&aacute;rios estar&atilde;o neste grupo e este grupo ir&aacute; se tornar o grupo padr&atilde;o dos mesmos. Esta op&ccedil;&atilde;o ir&aacute; servir caso queira determinar um rank ou avatar padr&atilde;o para usu&aacute;rios rec&eacute;m cadastrados para controle maior',
...
// Feeds
$lang = array_merge($lang, array(
	'ACP_FEED_MANAGEMENT'				=> 'Geral Syndication Feeds op&ccedil;&otilde;es (RSS)',
	'ACP_FEED_MANAGEMENT_EXPLAIN'		=> 'Este m&oacute;dulo torna dispon&iacute;vel v&aacute;rios Feeds ATOM, passando qualquer BBCode em mensagens para fazer com que o mesmo seja interpretado pelos feed externos.',

	'ACP_FEED_GENERAL'					=> 'Defini&ccedil;&otilde;es gerais de feed ',
	'ACP_FEED_POST_BASED'				=> 'Baseado em mensagens defini&ccedil;&otilde;es de feeds',
	'ACP_FEED_TOPIC_BASED'				=> 'Baseado em t&oacute;picos defini&ccedil;&otilde;es de feeds',
	'ACP_FEED_SETTINGS_OTHER'			=> 'Outros feeds e defini&ccedil;&otilde;es',

	'ACP_FEED_ENABLE'					=> 'Habilitar Feeds',
	'ACP_FEED_ENABLE_EXPLAIN'			=> 'Habilita e Desabilita ATOM Feeds para toda a comunidade.<br />Desabilitando isto ir&aacute; remover todos os Feeds da comunidade, n&atilde;o importando para quem este t&oacute;pico pertencer.',
	'ACP_FEED_LIMIT'					=> 'N&uacute;mero de &iacute;tens',
	'ACP_FEED_LIMIT_EXPLAIN'			=> 'O m&aacute;ximo de n&uacute;mero de feed para serem mostrados.',

	'ACP_FEED_OVERALL'					=> 'Habilitar feed toda comunidade',
	'ACP_FEED_OVERALL_EXPLAIN'			=> 'Novas mensagems por toda comunidade.',
	'ACP_FEED_FORUM'					=> 'Habilitar feeds por f&oacute;rums',
	'ACP_FEED_FORUM_EXPLAIN'			=> 'F&oacute;rum e subf&oacute;rum sozinhos em novos t&oacute;picos.',
	'ACP_FEED_TOPIC'					=> 'Habilitar feeds por t&oacute;picos',
	'ACP_FEED_TOPIC_EXPLAIN'			=> 'T&oacute;pico sozinho de nova mensagem.',

	'ACP_FEED_TOPICS_NEW'				=> 'Habilitar feed de novos t&oacute;picos',
	'ACP_FEED_TOPICS_NEW_EXPLAIN'		=> 'Habilita o â€œNovo T&oacute;picoâ€ feed, no qual mostra o &uacute;ltimo t&oacute;pico criado incluindo a primeira mensagem.',
	'ACP_FEED_TOPICS_ACTIVE'			=> 'Habilita t&oacute;picos de feed ativo',
	'ACP_FEED_TOPICS_ACTIVE_EXPLAIN'	=> 'Habilita o â€œT&oacute;picos Ativosâ€ feed,  no qual mostra o &uacute;ltimo t&oacute;pico criado incluindo a &uacute;ltima mensagem.',
	'ACP_FEED_NEWS'						=> 'Novos feed',
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Puxa a primeira mensagem destes f&oacute;rums. Selecione nenhum f&oacute;rum para desabilitar o novos feed.<br />Selecione v&aacute;rios f&oacute;rums segurando o <samp>CTRL</samp> e clicando.',

	'ACP_FEED_OVERALL_FORUMS'			=> 'Habilita feed por todo o f&oacute;rum',
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> 'Este feed mostra o &uacute;ltima mensagem de todos os t&oacute;picos dos f&oacute;rums.',
	'ACP_FEED_OVERALL_FORUMS_LIMIT'		=> 'N&uacute;mero de &iacute;tens por p&aacute;gina para mostrar nos feeds de f&oacute;rum',

	'ACP_FEED_HTTP_AUTH'				=> 'Permite autentica&ccedil;&atilde;o HTTP',
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Habilita autentica&ccedil;&atilde;o HTTP, no qual permite usu&aacute;rios receberem conte&uacute;do que &eacute; oculto dos usu&aacute;rios visitantes por adicionar <samp>auth=http</samp> parametro para o feed URL. Favor notar que alguns setups de PHP requerem mudan&ccedil;as adicionais no arquivo .htaccess. Instru&ccedil;&otilde;es podem ser encontradas neste mesmo arquivo.',
	
	'ACP_FEED_OVERALL_TOPIC'			=> 'Habilita sobre todos os t&oacute;picos',
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Habilita o “Todos T&oacute;picos” feed',
	'ACP_FEED_OVERALL_TOPIC_LIMIT'		=> 'N&uacute;mero de itens por p&aacute;gina para mostrar no feed de t&oacute;picos',
	'ACP_FEED_FORUM'					=> 'Habilita Por-F&oacute;rum Feeds',
	'ACP_FEED_FORUM_EXPLAIN'			=> 'Nova Mensagem de f&oacute;rum sozinha.',
	'ACP_FEED_TOPIC'					=> 'Habilita Por-T&oacute;pico Feeds',
	'ACP_FEED_TOPIC_EXPLAIN'			=> 'Novas mensagem de t&oacute;pico sozinho.',
	'ACP_FEED_NEWS'						=> 'Novos Feeds',
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Puxa a primeira mensagem destes f&oacute;rums. Selecione nenhum f&oacute;rum para desabilitar este feed.<br />Selecione m&uacute;ltiplos f&oacute;rums segurando o comando <samp>CTRL</samp> e clicando.',

	'ACP_FEED_GENERAL'					=> 'Op&ccedil;&otilde;es Gerais de Feed',

	'ACP_FEED_ITEM_STATISTICS'			=> 'Estat&iacute;stica do item',
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> 'Demonstra estat&iacute;stica individual do mais pr&oacute;ximo item de feed<br />(Autor, data e hora, Respostas, Visitas)',
	'ACP_FEED_EXCLUDE_ID'				=> 'Excluir estes f&oacute;rums',
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'Conte&uacute;do desses n&atilde;o ir&aacute; ser <strong>inclu&iacute;do nos feeds</strong>. Selecionando nenhum dos f&oacute;rums para puxar dados de todos os f&oacute;rums.<br />Seleciona/Deselecione m&uacute;ltiplos f&oacute;rums segurando o <samp>CTRL</samp> e clicando.',
));
...
$lang = array_merge($lang, array(
	...
	'AVAILABLE_CAPTCHAS'					=> 'Plugins dispon&iacute;veis',
	'CAPTCHA_UNAVAILABLE'					=> 'O CAPTCHA n&atilde;o pode ser selecionado quando seus requerimentos n&atilde;o s&atilde;o encontrados.',
...
// Mudanças 3.0.6	
	...
	'CAPTCHA_PREVIEW_MSG'					=> 'Suas mudancas para a confirma&ccedil;&atilde;o visual n&atilde;o foram salvas, isto &eacute; apenas um preview.',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> 'O CAPTCHA como dever&aacute; aparecer usando as seguintes sele&ccedil;&otilde;es.',

	'CAPTCHA_SELECT'						=> 'Plugins de CAPTCHA instalados',
	'CAPTCHA_SELECT_EXPLAIN'				=> 'O dropdown contem os plugins de CAPTCHA reconhecidos pelo phpBB nesta comunidade. Op&ccedil;&otilde;es em cinza n&atilde;o foram encontradas pelo sistema e podem requere sua configura&ccedil;&atilde;o.',
	'CAPTCHA_CONFIGURE'						=> 'Configurar CAPTCHAs',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Mude as op&ccedil;&otilde;es para o CAPTCHA selecionado.',
	'CONFIGURE'								=> 'Configurar',
	'CAPTCHA_NO_OPTIONS'					=> 'Este CAPTCHA n&atilde;o tem op&ccedil;&otildes;es de configura&ccedil;&atilde;o.',

	'VISUAL_CONFIRM_POST'					=> 'Habilitar confirma&ccedil;&atilde;o visual para visitantes',
	...
	'VISUAL_CONFIRM_REG_EXPLAIN'			=> 'Requer novos usu&aacute;rios entrar uma sequencia de caracteres para que sua mensagem seja adicionada a comunidade, evita que seja adicionada mais do que o preciso para o mesmo.',
	'VISUAL_CONFIRM_REFRESH'				=> 'Habilita o refresh da imagem por usu&aacute;rios',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Permite usu&aacute;rios requerer uma nova imagem de confirma&ccedil;&atilde;o, caso eles n&atilde;o consigam reconhecer os caracteres presente na imagem que lhe solicita para adicionar a mensagem. Alguns plugins n&atilde;o possuem esta op&ccedil;&atilde;o.',
	// Mudanças 3.0.6
));
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> 'Conte&uacute;do gerado ser&aacute; comprimido antes de mostrar ao usu&aacute;rio. Isto ir&aacute; reduzir os gastos com banda do servidor, mas ir&aacute; aumentar o uso do CPU tanto no cliente como no servidor. Requer que seu servidor tenha instalado ZLIB.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Se este estiver desabilitado, nenhum e-mail ser&aacute; enviado pela comunidade, nem de cadastro. <em>Note que usu&aacute;rio e administrador na ativa&ccedil;&atilde;o requer ativo esta op&ccedil;&atilde;o. Se atualmente usando usu&aacute;rio ou admin, desabilitando este n&atilde;o ir&aacute; requerer ativa&ccedil;&atilde;o de cadastro para estes.</em>',
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Entre com uma senha somente se seu servidor SMTP requerer uma. <em><strong>Aviso:</strong> esta senha &eacute; guardada como texto plano sem criptografia no banco de dados.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
...
$lang = array_merge($lang, array(
	...
	'JAB_PASSWORD_EXPLAIN'		=> '<em><strong>Aviso:</strong> esta senha &eacute; armazenada como texto plano no banco de dados, sem criptografia.</em>',
