...
if ($show_calendar && !empty($default_picture)) {
	...
	$style .= "background: transparent url(".JURI::base()."images/stories/".$default_picture.") top center no-repeat !important;";
	$style .= "} ";
				...
				<?php if ($show_image) : ?>				
					...
					<?php elseif (!empty($default_picture)) : ?>	
						<div class="picture">
							<?php if ($show_link) : ?>
								<a href="<?php echo $item->link; ?>" title="<?php echo $item->title; ?>" >
									<?php echo JHTML::_('image', JURI::base().'images/stories/'.$default_picture, '', array('class' => 'defaultpicture')); ?>
								</a>
							<?php else : ?>
								<?php echo JHTML::_('image', JURI::base().'images/stories/'.$default_picture, '', array('class' => 'defaultpicture')); ?>
							<?php endif; ?>							
