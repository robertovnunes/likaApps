        ...
        <table width="584" class="style5">
        	<tr>
              	...
              	<td colspan="2"><input name="nome" onfocus="mudaLb(lbnome)" onkeyup="savCampo()"
			  		value="<?php echo $_POST['nome']; if($_GET['er']=1)echo $_GET['nome'];?>" size="65" maxlength="50" /></td>
            </tr>
            <tr>
            	<td align="right" id="lbsexo" <?php if ($error && $_POST['sexo'] == ""){ echo 'class="erro"'; }?>>Sexo*:</td>
                <td><input name="sexo" type="radio" value="M" <?php if ($_POST['sexo'] == "M" || $_GET['sexo']=="M"){ echo "checked='checked'"; }?>
					onfocus="mudaLb(lbsexo)" onchange="savCampo()"/> Masculino
              	<input name="sexo" type="radio" value="F" <?php if ($_POST['sexo'] == "F" || $_GET['sexo']=="F"){ echo "checked='checked'"; }?> 	
                ...
                <td width="279"><span id="lbdt" <?php if ($error && $errnsc){ echo 'class="erro"'; }?>>Nascimento*:</span>
             		<input name="data" size="12" maxlength="10" onkeypress="mascara(this,2)" value="<?php echo $_POST['data']; echo $_GET['data']; ?>" onkeyup="savCampo()" onfocus="mudaLb(lbdt)"/> (dd/mm/aaaa)
...
<A HREF="#" onClick="cal19.select(document.forms[0].data,'anchor19','dd/MM/yyyy'); return false;" TITLE="cal19.select(document.forms[0].data,'anchor19','MM/dd/yyyy'); return false;" NAME="anchor19" ID="anchor19"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></A>
            ...
            <tr>
              ...
              <td width="179"><input name="cpf" maxlength="14" OnKeyPress="mascara(this,1)" value="<?php echo $_POST['cpf']; echo $_GET['cpf'];?>"	onkeyup="savCampo()" onfocus="mudaLb(lbcpf)"/></td>
            ...
            <tr>
              <td align="right" id="lbmae" <?php if ($error && $_POST['mae'] == ""){ echo 'class="erro"'; }?>> Nome da M&atilde;e*:</td>
            	<td colspan="2"><input name="mae" size="65" maxlength="50" value="<?php echo $_POST['mae']; echo $_GET['mae'];?>" 
					onfocus="mudaLb(lbmae)" onkeyup="savCampo()"/></td>
            </tr>
            <tr>
              <td align="right">Nome do Pai:</td>
              <td colspan="2"><input name="pai" size="65" maxlength="50" value="<?php echo $_POST['pai']; echo $_GET['pai'];?>" 
					onkeyup="savCampo()"/></td>
            </tr>
        </table>
        </fieldset>
            ...
            <table width="570" class="style5">
                ...
                <tr>
                    ...
                    <?php while ($dados = mysql_fetch_array($sql_estados)) { ?>
                        <option value="<?php echo $dados['cod_estado']; ?>" <?php echo checkOption("estado", $dados['cod_estado'], "");?>>
                    ...
                    <?php while ($dados1 = mysql_fetch_array($sql_cidades)){ ?>
                        <option value="<?php echo $dados1['cod_cidade']; ?>" <?php echo checkOption("cidade",$dados1['cod_cidade'],"");?>>
