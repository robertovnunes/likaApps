...
//-->
		...
		}else if ($n == "exame_medind"){
			echo'<div id="div_exame" class="conteudo" height:500px">';
			include("prontuario/exame/aba_medind.php");
		}
		...
		<?php if ($n == "is" || $n == "hd" || $n == "exame" || $n == "exame_inspec"|| $n == "exame_gang"|| $n == "exame_pele" ||$n == "exame_estpub"||$n == "exame_desneuro"||$n == "exame_olhos" ||$n == "exame_cranio"||$n == "exame_sistotor"||$n == "exame_apresp"||$n == "exame_cardio"||$n == "exame_pescoco"||$n == "exame_apgast"||$n == "exame_genurin"||$n == "exame_muscesq"||$n == "exame_nervoso" || $n == "exame_medind" || $n == "conduta" || $n == "qpdhda" || $n == "pele" || $n == "olhos" || $n == "ouvidos" || $n == "respiratorio" || $n == "cardiovascular" || $n == "gastrointestinal" || $n == "genitourinario" || $n == "musculoesqueletico" || $n == "nervoso" || $n == "geral"){ ?> 	
		<div id="myDiv"></div>
		...
		<table width="590">
			<tr >
				...
				<td align="right" width="1"><input type="hidden" name="gamb" value="false"
					id="gamb" /> <?php   if ($n == "exame" || $n == "exame_inspec"|| $n == "exame_gang"|| $n == "exame_pele" || $n =="exame_desneuro" || $n == "exame_estpub"||$n == "exame_olhos" ||$n == "exame_cranio"||$n == "exame_sistotor"||$n == "exame_apresp"||$n == "exame_cardio"||$n == "exame_pescoco" ||$n == "exame_apgast"||$n == "exame_genurin"||$n == "exame_muscesq"||$n == "exame_nervoso" || $n == "exame_medind"){
					...
					onclick="verificarExame(
						<?php echo $inspecao." ,  ".$pele." ,  ".$ganglios." ,  ".$estadpuberal." ,  ".$desenvneuropsicomotor." ,  ".$cranio." ,  ".$olhos." ,  ".$sistotorrino." ,  ".$pescoco." ,  ".$aprespiratorio ." ,  ".$apcardiovascular." ,  ".$apgastroint ." ,  ".$apgenitourinario." ,  ".$apmuscesqueletico." ,  ".$sistnervoso.", ".$medind; ?>
						); " /></td>
				...
				<td align="right" ><input  name="salvar" type="submit" id="salvar" 
					...
					else if(  $n == "exame_inspec"|| $n == "exame_gang"|| $n == "exame_pele" ||$n == "exame_estpub"||$n == "exame_desneuro"||$n == "exame_olhos" ||$n == "exame_cranio"||$n == "exame_sistotor"||$n == "exame_apresp"||$n == "exame_cardio"||$n == "exame_pescoco"||$n == "exame_apgast"||$n == "exame_genurin"||$n == "exame_muscesq"||$n == "exame_nervoso" || $n == "exame_medind"){
					...
					document.getElementById("pront").submit();
						...
						//window.onclick = function(){
 						...
 						var overlay = new myOverlay();
							overlay.confirm('Voce não salvou os seguintes itens: <br>'+erroJanela+'.<br> Deseja assinar?','','','','','o');						   
								//document.getElementById("gamb").value = "true";
							//	document.getElementById("pront").submit();
		...
		function verificarIs(geral, pele, olhos,ouvidos,respiratorio , cardiovascular, gastroint , genitourinario, muscesqueletico, nervoso ){
			...
			if(erroJanela == "" ){
				...
				document.getElementById("pront").submit();	
							...
							var overlay = new myOverlay();
							overlay.confirm('Voce não salvou os seguintes itens: <br>'+erroJanela+'. <br>Deseja assinar?',"gamb","pront");
							//	document.getElementById("gamb").value = "true";
							//	document.getElementById("pront").submit();
