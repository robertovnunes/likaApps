...
<html>
	<head>
		...
		<script src="script/professor.js" type="text/javascript"></script>
		...
		<div id="conteudo">		
			...
			<div id="right">
				...
				<p id="lista-carregando">
					<img src="img/spinner_odd.gif" alt=""/> Carregando lista de professores...
				</p>
				<p id="lista-vazia">
					Não há professores.
				</p>
				...
				<table id="tabela" class="lista">
					<tr>
						<th class="linha_media">Nome</th>
						<td class="linha_cpf escondido"></td>
						<th class="linha_media">Login</th>
