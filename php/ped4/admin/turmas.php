...
<html>
	<head>
		...
		<script src="script/turma.js" type="text/javascript"></script>
		...
		<div id="conteudo">		
			...
			<div id="right">
				...
				<div class="popup">
					<form>
						...
						<div>
							...
							<input class="entrada-grande" type="text" name="periodo"></input>
						</div>
				...
				<p id="lista-carregando">
					<img src="img/spinner_odd.gif" alt=""/> Carregando lista de turmas...
				</p>
				<p id="lista-vazia">
					Não há turmas.
				</p>
