<?php
	include ($_SERVER['DOCUMENT_ROOT'].'/ped/admin/classes/usuario.class.php');
...
<html>
	<head>
		...
		<script src="script/aluno.js" type="text/javascript"></script>
		...
		<div id="conteudo">		
			...
			<div id="right">
				...
				<div class="popup">
					<form>
						...
						<div class="entrada">
							...
							<input class="entrada-grande" type="text" name="cpf"></input>
						</div>
						<div class="entrada">
							<label for="login" >Login: </label>
							<input class="entrada-grande" type="text" name="login"></input>
						</div>
                        <div class="entrada">
							<label for="email" >E-mail: </label>
							<input class="entrada-grande" type="text" name="email"></input>
						</div>
						<div class="entrada">
							<label for="senha">Senha: </label>
							<input class="entrada-grande" type="password" name="senha"></input>
						</div>
						<div class="entrada">
							<label for="equipe">Equipe: </label>
							<select class="entrada-grande" name="equipe">
								<option class="template-equipe"></option>
								<option class="template-equipe-vazia" value=0>Nenhuma Equipe Cadastrada</option>
							</select>
						</div>
				...
				<p id="lista-carregando">
					<img src="img/spinner_odd.gif" alt=""/> Carregando lista de usuarios...
				</p>
				<p id="lista-vazia">
					Não há usuarios.
				</p>
				...
				<table id="tabela" class="lista">
					<tr>
						<th class="linha_pequena" class="linha_pequena">Nome</th>
						<th class="escondido">CPF</th>
						<th>Login</th>
                        <th>E-mail</th>
						<th class="linha_pequena">Equipe</th>
						<th class="linha_acoes">Ações</th>
					</tr>
					<tr class="template even">
						<td class="linha_nome"></td>
						<td class="linha_cpf escondido"></td>
						<td class="linha_login"></td>
                        <td class="linha_email"></td>
						<td class="linha_equipe"></td>
						<td>
			...
			<div id="rodape">
				<img src="img/logoufpe1.png" width="32" height="32" class="ufpe"/> © Copyright iDEIAS 2008-2009
