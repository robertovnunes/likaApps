<?php
if ($error == 1){
    echo '<table width="620" bgcolor="#629BD2"><tr><td class="erro">';
...
<form action="alterar_paciente.php?pr=<?php echo $pront; ?>" method="post" name="altpaciente" style="padding-left:45px;">
    ...
    <table width="620">
    	<tr>
       		<td width="566" bgcolor="#F0F0F0" class="style5">
			<p />
        	<fieldset>
        		<legend style="font-family:Trebuchet MS; font-size:15px;font-color:">DADOS PESSOAIS</legend>
            	<table width="570" class="style5">
            		...
            		<tr>
            			...
            			<td><input name="data" size="12" onfocus="mudaLb(lbdt)" onkeypress="mascara(this,2)" onkeyup="savCampo()" 
							...
							else echo printCampo(printData($paciente->dtnasc), $_POST['data']); ?>" maxlength="10"/></td>
            		</tr>
            		<tr>
