...
<table width="570" class="style5">
	<tr>
  	...
  	<tr>
			...
			<br />
			<textarea name="texpagtox" cols="80" onkeyup="savCampo('9')" onfocus="mudaLb(lblexpag)" <?php echo checkDisable("expagtox", $linfo->agtox, "S"); ?>><?php echo printOBS($linfo->tagtox, $_POST['texpagtox']); ?></textarea>
		</fieldset></td>
  	</tr>
	<tr>
  		<td colspan="2"><fieldset>
			...
			<br />
			<textarea name="talergmed" cols="80" onkeyup="savCampo('9')" onfocus="mudaLb(lblalgmed)" <?php echo checkDisable("alergmed", $linfo->alergmed, "S"); ?>><?php echo printOBS($linfo->talergmed, $_POST['talergmed']); ?></textarea>
		</fieldset></td>
  	</tr>
  	<tr>
  	...
  	<tr>
			...
			<textarea name="obsoutinfo" cols="80" onkeyup="savCampo('9')"><?php echo printOBS($linfo->obs, $_POST['obsoutinfo']); ?></textarea>
		</fieldset></td>
  	</tr>
</table>
