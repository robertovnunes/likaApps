...
<table width="570" class="style5">
  	...
  	<tr>
    	<td colspan="3"><fieldset>
			<legend id="lblanalg" <?php if ($errnt && !$linha->ass && $_POST['analgesia'] == "")?>>
				Analgesia</legend>
			<textarea name="analgesia" cols="80" onkeyup="savCampo('2')" onfocus="mudaLb(lblanalg)"><?php echo printOBS($lnat->analg,$_POST['analgesia']); ?></textarea>
		</fieldset></td>
  	</tr>
  	<tr>
		<td colspan="3"><fieldset>
			...
			<br />
			<textarea name="tcomparto" cols="80" onkeyup="savCampo('2')" onfocus="mudaLb(lblcomp)" 
	...
	<tr>
    	<td colspan="3"><fieldset>
			...
			<textarea name="obsnatal" cols="80" onkeyup="savCampo('2')"><?php echo printOBS($lnat->obs, $_POST['obsnatal']); ?></textarea>
		</fieldset></td>
  	</tr>
</table>