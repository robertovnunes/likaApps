...
<table width="550" class="style7" bgcolor="#E8E8E8">
	<tr>
    	<td>Pessoal > Doen&ccedil;as Anteriores</td>
...
<table width="570" class="style5">
	...
	<tr>
		<td colspan="2"><fieldset>
			...
			<textarea name="talerg" cols="70" onkeyup="savCampo('8')" onfocus="mudaLb(lblalerg)" 
	...
	<tr>
		<td colspan="2"><fieldset>
			...
			<textarea name="tratamentos" cols="70" onkeyup="savCampo('8')" onfocus="mudaLb(lbltreal)"><?php echo printOBS($ldoenc->trat, $_POST['tratamentos']); ?></textarea>
		</fieldset></td>
	</tr>
	<tr>
		<td colspan="2"><fieldset>
			<legend>Observa&ccedil;&otilde;es</legend>
			<textarea name="obsdoenant" cols="70" onkeyup="savCampo('8')"><?php echo printOBS($ldoenc->obs, $_POST['obsdoenant']);?></textarea>
		</fieldset></td>
	</tr>
</table>
