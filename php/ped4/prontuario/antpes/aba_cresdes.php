...
<table width="550" class="style7" bgcolor="#E8E8E8">
	<tr>
    	<td>Pessoal > Crescimento e Desenvolvimento</td>
...
<table width="570" class="style5">
	<tr>
    	<td><fieldset>
			...
			<textarea name="relirm" cols="70" onkeyup="savCampo('5')"><?php echo printOBS($lcd->relirm, $_POST['relirm']); ?></textarea>
		</fieldset></td>
  	</tr>
  	<tr>
	...
	<tr>
    	<td><fieldset>
			...
			<textarea name="aprend" cols="70" onkeyup="savCampo('5')"><?php echo printOBS($lcd->aprend, $_POST['aprend']);?></textarea>
		</fieldset></td>
  	</tr>
  	<tr>
    	<td><fieldset>
			<legend>Repet&ecirc;ncia de Ano</legend>
			<textarea name="repetano" cols="70" onkeyup="savCampo('5')"><?php echo printOBS($lcd->repetano, $_POST['repetano']); ?></textarea>
		</fieldset></td>
  	</tr>
  	<tr>
    	<td><fieldset>
			<legend>Relacionamento com Colegas e Professores</legend>
			<textarea name="relacol" cols="70" onkeyup="savCampo('5')"><?php echo printOBS($lcd->relac, $_POST['relacol']); ?></textarea>
		</fieldset></td>
  	</tr>
  	<tr>
    	<td><fieldset>
			<legend>Particularidades da Fala</legend>
			<textarea name="particfala" cols="70" onkeyup="savCampo('5')"><?php echo printOBS($lcd->partfala, $_POST['particfala']); ?></textarea>
		</fieldset></td>
  	</tr>
  	<tr>
    	<td><fieldset>
			<legend>Erup&ccedil;&atilde;o e Mudan&ccedil;a Dent&aacute;ria</legend>
			<textarea name="muddent" cols="70" onkeyup="savCampo('5')" ><?php echo printOBS($lcd->muddent, $_POST['muddent']); ?></textarea>
		</fieldset></td>
  	</tr>
	<tr>
		<td><fieldset>
			<legend>Observa&ccedil;&otilde;es</legend>
			<textarea name="obscrescdes" cols="70" onkeyup="savCampo('5')"><?php echo printOBS($lcd->obs, $_POST['obscrescdes']);?></textarea>
		</fieldset></td>
	</tr>
</table>
