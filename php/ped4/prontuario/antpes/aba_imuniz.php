...
<table width="550" class="style7" bgcolor="#E8E8E8">
	<tr>
    	<td>Pessoal > Imuniza&ccedil;&otilde;es</td>
		...
		<table width="500" align="center" class="style5">
			...
			<tr align="center">
				...
				<td><input name="datavacina" size="12" maxlength="10"
					...
					value="<?php echo $_POST['datavacina']; ?>" onkeyup="savCampo()" />
...
(dd/mm/aaaa)<A HREF="#" onClick="cal19.select(document.forms[0].datavacina,'anchor19','dd/MM/yyyy'); return false;" TITLE="cal19.select(document.forms[0].datavacina,'anchor19','MM/dd/yyyy'); return false;" NAME="anchor19" ID="anchor19"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></A>
...
<table width="570" class="style5">
	<tr>
		...
		Efeitos Colaterais</legend> <textarea name="efeitcol" cols="70"
	...
	<tr>
		...
		<fieldset><legend>Observa&ccedil;&otilde;es</legend> <textarea
			name="obsimun" cols="70" onkeyup="savCampo('7')"><?php echo printOBS($limun->obs, $_POST['obsimun']); ?></textarea>
		</fieldset>
		</td>
	</tr>
</table>
