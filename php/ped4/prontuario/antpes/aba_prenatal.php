	...
	<tr>
    	...
    	<td colspan="2"><fieldset>
    	    ...
    	    <table width="530" class="style5">
            	<tr class="style5">
                	...
                	<td width="461"><textarea name="tdoencir" id="tdoencir" cols="62" onkeyup="savCampo('1')" onfocus="mudaLb(lblcirug)"
  	...
  	<tr>
    	<td colspan="2"><fieldset>
			...
			<textarea name="obsprenat" cols="70" onkeyup="savCampo('1')"><?php echo printOBS($lpnat->obs, $_POST['obsprenat']); ?></textarea>
		</fieldset></td>
	</tr>
</table>
