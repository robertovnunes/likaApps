<?php
include ("classes/repositorioEX.php");
...
class NegocioEX {
	...
	public function alterarIEX($estger, $tdoenc, $aspdoenc, $desfis,$nutricao, $coop,$facies,$deffis,$anorpt,$obsins,$atend){
		$this->repEX->inspecao($estger, $tdoenc, $aspdoenc, $desfis,$nutricao, $coop,$facies,$deffis,$anorpt,$obsins,$atend);
	}

	public function alterarPeEX($corpele, $textpele, $umidpele, $temppele, $cicatriz, $descam, $hemorr,$rash,$circcol, $edemapele,
	$consun,$defun,$mancun,$influn, $obsepele, $atend){
		$this->repEX->pele($corpele, $textpele, $umidpele, $temppele, $cicatriz, $descam, $hemorr, $rash,$circcol,$edemapele,
		$consun, $defun,$mancun,$influn, $obsepele, $atend);
	}
	...
	public function alterarMedind($peso,$pesoin, $altura,$alturain, $permcef, $permtora, $permab, $pregatric, $pregasubesc, $atend){
		$this->repEX->alterarMedind($peso,$pesoin, $altura,$alturain, $permcef, $permtora, $permab, $pregatric, $pregasubesc, $atend);
	}
	...
	public function alterarCVEX($precord, $ictcrdi, $ictcrdp, $artper, $bulhas, $sopros,$pressaoart, $pressaoartin, $freqcard, $freqcardin, $obscdvs, $atend){
		$this->repEX->cardVasc($precord, $ictcrdi, $ictcrdp, $artper, $bulhas, $sopros, $pressaoart, $pressaoartin, $freqcard, $freqcardin, $obscdvs, $atend);
	}
