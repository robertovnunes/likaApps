...
<div class="level2">
  <ul>
    ...
    <li class="level1">
      <div class="li"><?php echo hsc($lang["monobook_cite_permurl"]); ?>: <a rel="nofollow" href="<?php echo hsc($permurl); ?>"><?php echo hsc($permurl); ?></a></div>
    </li>
    <li class="level1">
...
<div class="level3">
  <p>
     ...
     <?php echo hsc($lang["monobook_cite_in"]); ?> <em><?php echo hsc($conf["title"]); ?></em>.
     <?php echo hsc($lang["monobook_cite_retrieved"])." ".gmdate("H:i, F j, Y,")." ".hsc($lang["monobook_cite_from"]); ?>
...
<div class="level3">
  <p>
     ...
     &lt;<a rel="nofollow" href="<?php echo hsc($permurl); ?>"><?php echo hsc($permurl); ?></a>&gt; [<?php echo hsc($lang["monobook_cite_accessed"])." ".gmdate("j F Y"); ?>]
  </p>
</div>
...
<div class="level3">
  <p>
    ...
    "<?php tpl_pagetitle(); ?>",
    <em><?php echo hsc($conf["title"]); ?></em>,
    <a rel="nofollow" href="<?php echo hsc($permurl); ?>"><?php echo hsc($permurl); ?></a> (<?php echo hsc($lang["monobook_cite_accessed"])." ".gmdate("F j, Y"); ?>).
  </p>
</div>
...
<div class="level3">
  <p>
    ...
    <?php echo hsc($conf["title"])?>; <?php echo gmdate("Y M j, H:i T", $rev); ?> [<?php echo hsc($lang["monobook_cite_cited"])." ".gmdate("Y M j"); ?>].
    <?php echo hsc($lang["monobook_cite_availableat"]); ?>: <a rel="nofollow" href="<?php echo hsc($permurl); ?>"><?php echo hsc($permurl); ?></a>.
  </p>
</div>
...
<div class="level3">
  <p>
    <?php tpl_pagetitle(); ?>,
    <a rel="nofollow" href="<?php echo hsc($permurl); ?>"><?php echo hsc($permurl); ?></a> (<?php echo hsc($lang["monobook_cite_lastvisited"])." ".gmdate("F j, Y"); ?>).
  </p>
</div>
...
<div class="level3">
  <pre>
 @misc{ wiki:xxx,
   author = &quot;<?php echo str_replace(",", "{,}", tpl_getConf("monobook_cite_author")); ?>&quot;,
...
<h3><a name="talk_pages" id="talk_pages"><?php echo hsc($lang["monobook_cite_discussionpages"]); ?></a></h3>
<div class="level3">
  <dl>
    <dt><?php echo hsc($lang["monobook_cite_markup"]); ?></dt>
    <dd>[[<?php echo getID(); ?>|<?php tpl_pagetitle(); ?>]] ([[<?php echo hsc($permurl); ?>|<?php echo hsc($lang["monobook_cite_thisversion"]); ?>]])</dd>
  </dl>
  <dl>
    <dt><?php echo hsc($lang["monobook_cite_result"]); ?></dt>
    <dd><a rel="nofollow" class="wikilink1" href="<?php echo hsc(wl(cleanID(getId()))); ?>"><?php tpl_pagetitle(); ?></a> (<a rel="nofollow" class="urlextern" href="<?php echo hsc($permurl); ?>"><?php echo hsc($lang["monobook_cite_thisversion"]); ?></a>)</dd>
  </dl>
</div>
