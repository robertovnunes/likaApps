...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright)):
					...
					echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="#" target="_blank" rel="nofollow">Paulo Diniz </a>'.__('powered by','zerif-lite').'<a class="zerif-copyright" href="http://wordpress.org/" target="_blank" rel="nofollow"> WordPress</a></div>';
