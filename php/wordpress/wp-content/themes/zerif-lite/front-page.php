...
<?php
	...
	/* Laboratorios (OUR FOCUS SECTION) */
				...
				<div class="row">
					...
					<?php
						...
						if(isset($emailSent) && $emailSent == true) :
							...
							echo '<p class="error white-text">'.__('Obrigado, seu email foi enviado com sucesso!','zerif-lite').'</p>';

						elseif(isset($_POST['submitted'])):

							echo '<p class="error white-text">'.__('Pedimos desculpas, algum erro inesperado ocorreu. Tente novamente mais tarde.','zerif-lite').'<p>';
					...
					<form role="form" method="POST" action="" onSubmit="this.scrollPosition.value=document.body.scrollTop" class="contact-form">
						...
						<div class="col-lg-4 col-sm-4" data-scrollreveal="enter left after 0s over 1s">
							...
							<input type="text" name="myname" placeholder="Nome" class="form-control input-box" value="<?php if(isset($_POST['myname'])) echo $_POST['myname'];?>">
						...
						<div class="col-md-12" data-scrollreveal="enter right after 0s over 1s">
							...
							<textarea name="mymessage" class="form-control textarea-box" placeholder="Messagem"><?php if(isset($_POST['mymessage'])) { echo stripslashes($_POST['mymessage']); } ?></textarea>
