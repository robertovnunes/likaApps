...
include_once("classes/negocio/NegocioCidadeEstado.php");
...
class Fachada{
    ...
    public function __construct() {
		...
		$this->negCidEst = new NegocioCidadeEstado();
...
/******************************************* NEGOCIOGERAL *******************************************/	
	...
	function checkOptionIS($id, $value, $field) {
		return $this->negGeral->checkOptionIS($id, $value, $field);
	}
...
/******************************************* NEGOCIOPAC **********************************************/	
    ...
    public function cadastrarPaciente($paciente, $forcar, $login) {
       return $this->negPac->cadastrar($paciente, $forcar, $login);
    }
...
/**************************************** NEGOCIOCIDADEESTADO **********************************************/	
	...
	public function listarEstados() {
        return $this->negCidEst->listarEstados();
    }
	
	public function listarCidades($estado) {
        return $this->negCidEst->listarCidades($estado);
    }
	
	public function getEstado($id) {
        return $this->negCidEst->getEstado($id);
    }
	
	public function getCidade($id) {
        return $this->negCidEst->getCidade($id);
    }
...
/******************************************* NEGOCIOHDC **********************************************/	
	...
	public function confirmarHip($idHip, $idAluno){
		$this->negHDC->confirmarHip($idHip, $idAluno);
...
/**************************************** NEGOCIOHISTORICO *******************************************/	
    ...
    public function inserirNeoNatalHP($apgar1, $apgar5, $permnasal, $idadegest, $sangrn, $sinalorto, 
		...
		$infeccoes, $anomcong, $paralisias, $coriza, $convulsoes, $obsneonat, $pesoAtual, $spesoat, $alturaAtual, 
		$idProntuario) {
