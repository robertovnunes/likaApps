...
<fieldset class="full">
	...
	<fieldset style="width:31%">
		<legend id="lblPN" <?php echo (isset($lblpeson) ? $lblpeson : '');?>>Peso ao Nascer</legend>
		<select style="margin:0 0 0 10" name="spesonasc" onfocus="mudaLb(lblPN)"  onChange="savCampo('3');habilitaPesoNascer(this.value)" style="margin-top:4px;margin-right:10px">
			<option value="NA" <?php echo $pesonasc1; ?> >N&atilde;o Avaliado</option>
			<option value="AV" <?php echo $pesonasc2; ?> >Valor</option>
		</select>
		<input style="margin:0" name="pesonasc" onchange="savCampo('3')" onkeypress="mascara(this,6)" size="5" maxlength="5" value="<?php echo $pesonasc; ?>" <?php echo $dpesonasc; ?>/><label>g</label> 
	</fieldset>

	<fieldset style="width:30%">
		<legend >Comprimento ao Nascer</legend>
		<select name="comp" onchange="savCampo('3')">
			<option value='45' <?php echo $comp1; ?>>Menos de 47 cm</option>
			<option value='47' <?php echo $comp2; ?>>47 a 50 cm</option>
			<option value='51' <?php echo $comp3; ?>>Mais de 50 cm</option>
	...
	<fieldset style="width:35%">
		<legend id="lblPA" <?php echo (isset($lblpesoat) ? $lblpesoat : '');?>>Peso Atual</legend>
		<select style="margin:0 0 0 10" name="spesoat" onfocus="mudaLb(lblPA)"  onChange="savCampo('3');habilitaPesoAtual(this.value)" style="margin-top:4px;margin-right:10px">
			<option value="NA" <?php echo $spesoat1; ?> >N&atilde;o Avaliado</option>
			<option value="AV" <?php echo $spesoat2; ?> >Valor</option>
		</select>
	...
	<fieldset style="width:35%">
		...
		<select name="percef" onchange="savCampo('3')">
			<option value='33' <?php echo $percef1; ?>>Menos de 34 cm</option>
			<option value='35' <?php echo $percef2; ?>>34 a 36 cm</option>
			<option value='37' <?php echo $percef3; ?>>Mais de 36 cm</option>
			<option value='NA' <?php echo $percef4; ?>>N&atilde;o Avaliado</option>
		</select>
	</fieldset>
	
	   <!-- <select id="pesonasc" name="pesonasc" onchange="savCampo('3')">
			<option value='1400'<?php //echo $pesonasc1; ?>>Menos de 1500 g</option>
			<option value='2400'<?php //echo $pesonasc2; ?>>Menos de 2500 g</option>
			<option value='2700' <?php //echo $pesonasc3; ?>>2500 a 3000 g</option>
	...
	<fieldset style="width:35%">
		...
		<select name="pertorac" onchange="savCampo('3')">
			<option value='29' <?php echo $pertorac1; ?>>Menos de 30 cm</option>
			<option value='33' <?php echo $pertorac2; ?>>30 a 34 cm</option>
			<option value='35' <?php echo $pertorac3; ?>>Mais de 34 cm</option>
...
<fieldset class="full">
	...
	<div><span>
		<input name="testepe" type="radio" value="S" onclick="habilitaTestePez(1)" onchange="savCampo('3')" <?php echo $testepe1; ?>/><label>Sim</label>
		<input name="testepe" type="radio" value="N" onclick="habilitaTestePez(0)" onchange="savCampo('3')" <?php echo $testepe2; ?>/><label>N&atilde;o</label>
		<input name="testepe" type="radio" value="NA" onclick="habilitaTestePez(0)" onchange="savCampo('3')" <?php echo $testepe3; ?>/><label>N&atilde;o Avaliado</label>
	</span></div>
