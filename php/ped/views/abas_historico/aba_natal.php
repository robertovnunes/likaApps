...
<fieldset style="width:30%">
	<legend id="lbltrpart" <?php echo (isset($lbltrpart) ? $lbltrpart : ''); ?>>Dura&ccedil;&atilde;o Trabalho de Parto</legend>
	<input name="durparto" size="6" maxlength="5" onkeyup="savCampo('2')" value="<?php echo $durparto; ?>" onfocus="mudaLb(lbltrpart)" onKeyPress="return(MascaraDE(this,event))" /><label style="margin:4 0 0 0">(hh:mm)</label>
</fieldset>
...
<fieldset class="full">
	<legend id="lblcomp" <?php echo (isset($lblcomp) ? $lblcomp : ''); ?>>Complica&ccedil;&otilde;es</legend>
	<span>
