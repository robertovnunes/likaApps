...
<fieldset style="width:46%">
	...
	<select name="testiculos" <?php echo $ass; ?> onChange="savCampo('D')">
		<option value="N" <?php echo (isset($testiculos1) ? $testiculos1 : ''); ?>>Normais</option>
		<option value="A+" <?php echo (isset($testiculos2) ? $testiculos2 : ''); ?>>Aumentados</option>
		<option value="C" <?php echo (isset($testiculos3) ? $testiculos3 : ''); ?>>Criptorquidia</option>
		<option value="AT" <?php echo (isset($testiculos4) ? $testiculos4 : ''); ?>>Aus&ecirc;ncia de 1 test&iacute;culo</option>
		<option value="Au" <?php echo (isset($testiculos5) ? $testiculos5 : ''); ?>>Ausentes</option>
		<option value="NA" <?php echo (isset($testiculos6) ? $testiculos6 : ''); ?>>N&atilde;o Avaliado</option>
	</select>
</fieldset>
<?php } ?>
<fieldset style="width:46%">
