	<div id="rodape" <?php if($pagina != "index.php") { echo 'style="z-index:-1"';} $versao = "2.0.1";?>>
		<div id="rodapeimg">
		...
		<div id="logoUFPE"> <img src="images/logo_r2_c2.jpg">
			...
			<div id="recomenda">Site melhor visualizado no Mozilla Firefox 10+ ou Google Chrome, em resolução 1280 x 1024 pixels. <br><p align='center'> Versão <? echo "$versao"; ?> </p></div>
	</div>
</div>  
</body>
</html>
