    ...
    <fieldset class="bgFormPaciente">
		...
		?>
            ...
            <fieldset class="full">
				...
				<div>
					<input type="hidden" id="hdIdEst" value="<?php echo $valAlt[12]; ?>" />
					<label id="lbUF" class="labdir2<?php echo $cerrUF; ?>">UF*:</label>
					<select id="inpUF" name="uf" onkeyup="savCampo()" onfocus="mudaLb(lbUF)">
						<option value="0">Escolha o estado</option>
						<?php
						foreach($estados as $estado){
							if($estado['id'] == $valAlt[12])
				...
				<div>
					<input type="hidden" id="hdIdCid" value="<?php echo $valAlt[11]; ?>" />
