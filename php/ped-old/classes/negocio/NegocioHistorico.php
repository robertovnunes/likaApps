...
/*        } else
    ...
    private function parametrosInvalidosHF($uniaopais, $idademae, $profmae, $idadepai, $profpai, $pais, $avos, 
		...
		if (!is_numeric($idademae) || $idademae <= 0 || !$profmae || !$profpai || $tiporesid == "0" || 
			!is_numeric($ncomodos) || !is_numeric($nocupantes) || !$nocupantes  == "" || !$agua 
        ...
        $cirurgias, $pesograv, $anemia, $alimgrav)
    {
        if ($duracaogest == "0" || $acompmed == "" || $z21 == "0" || $a53 == "0" || $b18 ==
            ...
            || !is_numeric($pesograv) || $anemia == "" || $alimgrav == "0")
            return true;
        /*if ($medic == "")
            return true;*/
