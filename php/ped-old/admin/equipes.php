...
<html>
	<head>
		...
		<script src="script/equipe.js" type="text/javascript"></script>
		...
		<div id="conteudo">		
			...
			<div id="right">
				...
				<div class="popup">
					<form>
						...
						<div class="entrada">
							...
							<select class="entrada-grande" name="turma">
								<option class="template-turma"></option>
								<option class="template-turma-vazia" value=0>Nenhuma Turma Cadastrada</option>
							</select>
						</div>
						<div class="entrada">
							<label for="modulo">Modulo: </label>
							<select class="entrada-grande" name="modulo">
								<option class="template-modulo"></option>
								<option class="template-modulo-vazia" value=0>Nenhum Módulo Cadastrado</option>
							</select>
						</div>
				...
				<p id="lista-carregando">
					<img src="img/spinner_odd.gif" alt=""/> Carregando lista de equipes...
				</p>
				<p id="lista-vazia">
					Não há equipes.
				</p>
				...
				<table id="tabela" class="lista">
					<tr>
						...
						<th class="escondido">Descrição</th>
						<th class="linha_pequena">Turma</th>
						<th class="linha_pequena">Módulo</th>
						<th class="linha_acoes">Ações</th>
					</tr>
					<tr class="template even">
						<td class="linha_nome"></td>
						<td class="linha_descricao escondido"></td>
						<td class="linha_turma"></td>
						<td class="linha_modulo"></td>
						<td>
