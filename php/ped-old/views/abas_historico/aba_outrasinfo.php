...
<fieldset class="full">
	<legend id="lblexpag" <?php echo $lblexpag;?>>Exposi&ccedil;&atilde;o &agrave; Agentes T&oacute;xicos</legend>
	<span>
...
<fieldset class="full">
	<legend id="lblalgmed" <?php echo $lblalgmed; ?>>Alergia &agrave; Medicamento</legend>
	<span>
