...
<div style="float:left;width:70%">
	<fieldset style="width:95%">
		...
		<div style="float:left;margin-top:5px">
			<label id="lbLMed" class="labdir labtop<?php echo $lblmed; ?>">Local:</label>
...
<fieldset class="full">
	<legend id="lbMedic" <?php echo $lbMedic; ?>>Medica&ccedil;&otilde;es</legend>
...
<fieldset class="full">
	...
	<br /><br />
	<label id="lbCirug" <?php echo $lbCirug; ?>>Cirurgias:</label>
