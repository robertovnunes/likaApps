...
<fieldset class="full">
	...
	<div style="clear:both">
		<label class="labdir2<?php echo $lblidadmae; ?>" style="margin-top:8" id="lblidadmae">Idade da M&atilde;e:</label>
	...
	<div style="clear:both">
		<label class="labdir2<?php echo $ocupmae; ?>">Ocupa&ccedil;&atilde;o da M&atilde;e:</span></label>
	...
	<div style="clear:both">
		<label class="labdir2<?php echo $lblidadpai; ?>" style="margin-top:8" id="lblidadpai">Idade do Pai:</label>
	...
	<div style="clear:both">
		<label class="labdir2<?php echo $ocuppai; ?>">Ocupa&ccedil;&atilde;o do Pai:</label>
...
<fieldset class="full">
	...
	<fieldset class="full">
		...
		<div style="float:left">
			<label class="labdir2<?php echo $lblncom;?>" id="lblncom">N&ordm; de C&ocirc;modos:</label>
		...
		<div style="float:left">
			<label class="labdir2<?php echo $lblnocup;?>" id="lblnocup">N&ordm; de Ocupantes:</label>
