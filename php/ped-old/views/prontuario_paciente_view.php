...
<br />
<form action="prontuario_paciente.php?at=<?php echo $atend; ?>&aba=<?php echo $aba; ?>" method="post" name="<?php echo $aba; ?>" id="pront">
<div id="menuBarr">
	<fieldset>
        <legend>Menu</legend>
        <ul id="MenuBar1" class="MenuBarVertical">
            ...
            <li><a onclick="muda('<?php echo $atend; ?>','hd','p')">Hipótese de Diagn&oacute;stico</a></li>
...
<div id="formcadastro1">
    <fieldset>
		...
		<?php include_once("views/abas_prontuario/verAss.php");?>
			<div id="tPront">
			<br />
			<span class="style7"><?php echo $titulopront; ?></span>
			<br />
