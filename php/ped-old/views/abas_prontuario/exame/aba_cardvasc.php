...
<fieldset style="width:46%">
	<legend id="lblpart" <?php echo $lblpart; ?>>Press&atilde;o Arterial</legend>
	<select style="margin:4 0 0 10" name="pressaoart" onfocus="mudaLb(lblpart)" onChange="savCampo('B')" <?php echo $ass; ?>  >
		...
		<option value="AV" <?php echo $presart2; ?> onclick="habilitaExCardioPres(1)">Valor</option>
	</select> 
...
<fieldset style="width:46%">
	<legend id="lblfqcd" <?php echo $lblfqcd; ?>>Freq&uuml;&ecirc;ncia Card&iacute;aca</legend>
	<select style="margin:4 0 0 10" name="freqcard" onfocus="mudaLb(lblfqcd)" <?php echo $ass; ?> onChange="savCampo('B')">
		...
		<option value="AV" <?php echo $frqcrd2; ?> onclick="habilitaExCardioFreq(1)">Valor</option>
	</select>
