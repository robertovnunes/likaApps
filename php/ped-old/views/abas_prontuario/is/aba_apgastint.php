...
<div style="float:left;width:50%">
	<fieldset style="width:95%">
		...
		<select name="vomitos" <?php echo $ass; ?> onchange="savCampo('7')">
			<option value="AA" <?php echo $vomitos1; ?>>Normais</option>
			<option value="SC" <?php echo $vomitos2; ?>>Brancas</option>
			<option value="N" <?php echo $vomitos3; ?>>Escuras</option>
			<option value="NA" <?php echo $vomitos4; ?>>N&atilde;o Avaliado</option>
		</select>
	</fieldset>
...
<div style="float:left;width:50%">
	<fieldset style="width:95%">
		...
		<select name="aspfezes" <?php echo $ass." ".$devacuacao; ?> onchange="savCampo('7')">
			...
			<option value="NA" <?php echo $aspfezes4; ?>>N&atilde;o Avaliado</option>
		</select>
		<br />
