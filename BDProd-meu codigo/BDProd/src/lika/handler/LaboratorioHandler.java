...
public class LaboratorioHandler {
	...
	private List<Pessoa> desativados = new ArrayList<Pessoa>();
	private List<Pessoa> ativos =  new ArrayList<Pessoa>();
	...
	public void consultar() {
		try {
			...
			fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
					"ERRO: ao tentar listar os Laborat�rios " + e.getMessage(),
					""));
		}
	}
	...
	public String salvarLaboratorio() {
		...
		try {
			...
			fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
					"Laborat�rio " + this.laboratorioAtual.getNome()
							+ " salvo com sucesso!", ""));
		} catch (Exception e) {
			e.printStackTrace();
			fc.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
					"ERRO: ao tentar salvar o Laborat�rio " + e.getMessage(),
					""));
