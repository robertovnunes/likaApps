...
<f:subview id="lookupAreas">
	...
	<!-- ui-dialog -->
	<div id="dialogGrandeAreas" title="Associar Grande Área de Pesquisa"><h:form
		styleClass="niceform">
			...
			<rich:dataTable id="tabelaResultadoArea" value="#{areaHandler.areas}"
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true" onclick="jQuery('#dialogGrandeAreas').dialog('close')"
						value="Selecionar" reRender="panelAreas"
						actionListener="#{areaHandler.adicionarGrandeArea}">
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			...
			<a4j:commandLink onclick="jQuery('#dialogGrandeAreas').dialog('close')">
