...
<f:view>
	...
	<div id="page"><h:form>
		...
		<ul>
			...
			<h2>Opções</h2>
			<ul>
				<li><h:commandLink value="Nova Sub Área de Pequisa"
					action="#{sessionHandler.navigation.novoSubArea}"
					actionListener="#{areaHandler.novaSubArea}" /></li>
			</ul>
			</li>
		</ul>
		</div>
		...
		<div id="content"><a4j:region id="regiao">
			...
			<h:panelGroup id="campo">
				...
				<a4j:commandButton id="botaoBuscar" value="Buscar"
					action="#{areaHandler.listarSubAreaPorNome}" reRender="panel"
			...
			<a4j:outputPanel id="panel">
				...
				<h:panelGroup rendered="#{empty areaHandler.subAreas }">
					<div id="nenhum" align="center" style="color: red;"><h:outputText
						value="Nenhuma Sub Área de Pesquisa econtrado. " /></div>
				</h:panelGroup>
				...
				<h:panelGroup rendered="#{not empty areaHandler.subAreas }">
					<div class="titulo" style="margin-left: 15px; margin-bottom: 15px">
					<h:outputText value="Sub Áreas de Pesquisa" /></div>

					<div style="margin-left: 10px;"><rich:dataTable
						id="tabelaResultado" value="#{areaHandler.subAreas}" var="func"
						...
						<rich:column id="opcoes">
							...
							<h:commandLink
								action="#{sessionHandler.navigation.visualizarSubArea}"
								actionListener="#{areaHandler.carregarSubArea}">
								<f:attribute name="idSubArea"
									value="#{func.idSubAreaDePesquisa}" />
								<h:graphicImage value="../images/editar4.png"
									style="border:none;" title="Editar Sub Área de Pesquisa"
									alt="Editar Sub Área de Pesquisa" width="17" height="17"></h:graphicImage>
