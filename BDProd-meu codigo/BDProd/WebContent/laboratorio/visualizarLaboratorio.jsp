...
<f:subview id="visualizarLaboratorio">
	...
	<fieldset><legend>Integrantes em Atividade</legend> <h:panelGroup
		...
		<h:panelGroup
			...
			<div id="lista_Visualizar"><rich:dataList
				...
				<h:outputText value="#{pessoa.situacao}" styleClass="label" />	
				<br />
				<br />
			</rich:dataList>
			</div>
	...
	<fieldset><legend>Integrantes Desligado</legend> <h:panelGroup
