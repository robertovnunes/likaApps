...
<f:subview id="lookupSubAreas">
	...
	<!-- ui-dialog -->
	<div id="dialogSubAreas" title="Associar Sub Área de Pesquisa ao Projeto"><h:form
		styleClass="niceform">
			...
			<rich:dataTable id="tabelaResultadoArea"
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true" onclick="jQuery('#dialogSubAreas').dialog('close')"
						value="Selecionar" reRender="panelAreas"
						actionListener="#{projetoHandler.adicionarSubArea}">
						<f:attribute value="#{subArea}" name="subArea" />
					</a4j:commandLink></div>
				</rich:column>
