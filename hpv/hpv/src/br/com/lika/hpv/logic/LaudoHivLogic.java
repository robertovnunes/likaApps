 ...
 import br.com.lika.hpv.interceptor.PerfilViralHivInterceptor;
 ...
 @Component("viralHiv")
 @InterceptedBy({DAOInterceptor.class, PerfilViralHivInterceptor.class, MultipartRequestInterceptor.class, PdfLaudoInterceptor.class})
 public class LaudoHivLogic
 {
   ...
   private List<LaudoHiv> laudosHiv;
   private List<Formulario> formularios;
   private List<ReagenteHIV> reagentes;
   private ReagenteHIV reagenteHIV;
   ...
   public LaudoHivLogic(DAOFactory f, ClientInput ci, ClientOutput co) {
     this.daoFactory = f;
     this.clientInput = ci;
   ...
   public void formulario(Formulario formulario) {
     ...
     this.reagentes = this.daoFactory.getReagenteHivDAO().listaTudo();
     this.laudoHiv = this.formulario.getLaudoHiv();
   }
   @Validate(params={"laudoHiv"})
   public void add(LaudoHiv laudoHiv) {
     this.daoFactory.beginTransaction();
     this.daoFactory.getLaudoHivDAO().atualiza(laudoHiv);
     this.daoFactory.commit();
   }
 
   public void edit(LaudoHiv laudoHiv) {
     this.laudoHiv = ((LaudoHiv)this.daoFactory.getLaudoHivDAO().procura(laudoHiv.getId()));
     this.formulario = this.laudoHiv.getFormulario();
   }
 
   public void remove(LaudoHiv laudoHiv) {
     this.daoFactory.beginTransaction();
     this.daoFactory.getLaudoHivDAO().remover(laudoHiv.getId());
     this.daoFactory.commit();
   }
 
   public void list() {
     this.laudosHiv = this.daoFactory.getLaudoHivDAO().listaTudo();
   }
 
   public void formularioReagenteHIV(ReagenteHIV reagenteHIV) {
     if (reagenteHIV.getId() != null) this.reagenteHIV = ((ReagenteHIV)this.daoFactory.getReagenteHivDAO().procura(reagenteHIV.getId())); 
   }
 
   public void addReagenteHIV(ReagenteHIV reagenteHIV)
   {
     this.daoFactory.beginTransaction();
     reagenteHIV.setDataCadastro(new Date());
     this.daoFactory.getReagenteHivDAO().adiciona(reagenteHIV);
     this.daoFactory.commit();
   }
 
   public void removerReagenteHIV(ReagenteHIV reagenteHIV) {
     this.daoFactory.beginTransaction();
     this.daoFactory.getReagenteHivDAO().remover(reagenteHIV.getId());
     this.daoFactory.commit();
   }
 
   public void listarReagentesHIV() {
     this.reagentes = this.daoFactory.getReagenteHivDAO().listaTudo();
   }
 
   public void gerarPDF(LaudoHiv laudoHiv)
   {
     this.laudoHiv = ((LaudoHiv)this.daoFactory.getLaudoHivDAO().procura(laudoHiv.getId()));
   }
   ...
   public void gerarPdfLaudo(Formulario formulario) {
     this.laudoHiv = ((Formulario)this.daoFactory.getFormularioDAO().procura(formulario.getId())).getLaudoHiv();
 
     if (this.laudoHiv != null) {
       ...
       String nomePaciente = "";
       try {
         nomePaciente = this.laudoHiv.getFormulario().getInformacoesPessoais().getNome();
       ...
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<strong>Nº PRONTURÁRIO: </strong>" + this.laudoHiv.getFormulario().getNumeroProntuario());
       htmlPdf.append("\t</div>");
 
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<strong>IDADE: </strong>" + this.laudoHiv.getFormulario().getInformacoesPessoais().getIdade());
       htmlPdf.append("\t</div>");
 
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<strong>Unidade de Sa&uacute;de: </strong>" + this.laudoHiv.getUnidadeSaudeFamilia());
       htmlPdf.append("\t</div>");
 
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<strong>C&oacute;digo: </strong>" + this.laudoHiv.getCodigo() + "<br>");
       htmlPdf.append("\t</div>");
 
       htmlPdf.append("\t<div>");
       Date dataColeta = this.laudoHiv.getDataColeta();
       ...
       htmlPdf.append("\t<div>");
       Date dataLiberacao = this.laudoHiv.getDataEntrega();
       ...
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<p>RESULTADO DO EXAME DE HIV</p>");
       htmlPdf.append("\t</div>");
 
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<strong>Resultado: </strong>" + this.laudoHiv.getResultado() + "<br>");
       htmlPdf.append("\t</div>");
 
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<strong>Teste(reagente): </strong>" + this.laudoHiv.getReagente() + "<br>");
       htmlPdf.append("\t</div>");
 
       htmlPdf.append("\t<div>");
       htmlPdf.append("\t\t<strong>Observa&ccedil;&otilde;es: </strong>" + this.laudoHiv.getObservacoes() + "<br>");
       htmlPdf.append("\t</div>");
   ...
   public List<LaudoHiv> getLaudosHiv() {
     return this.laudosHiv;
   }
 
   public void setLaudosHiv(List<LaudoHiv> laudosHiv) {
     this.laudosHiv = laudosHiv;
   }
   ...
   public List<ReagenteHIV> getReagentes() {
     return this.reagentes;
   }
   public void setReagentes(List<ReagenteHIV> reagentes) {
     this.reagentes = reagentes;
   }
   public ReagenteHIV getReagenteHIV() {
     return this.reagenteHIV;
   }
   public void setReagenteHIV(ReagenteHIV reagenteHIV) {
     this.reagenteHIV = reagenteHIV;
   }
 ...
 * Qualified Name:     br.com.lika.hpv.logic.LaudoHivLogic
