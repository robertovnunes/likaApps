 ...
 public class PerfilDigitadorInterceptor
   implements Interceptor
 {
   ...
   {
     return this.usuarioDaSessao.getAcessoFormularioClinico().charValue() == 'Y';
   }
 }

/* Location:           D:\UFPE\LIKA\desenvolvimento\hpv\trunk\hpv\ImportedClasses\
 * Qualified Name:     br.com.lika.hpv.interceptor.PerfilDigitadorInterceptor
