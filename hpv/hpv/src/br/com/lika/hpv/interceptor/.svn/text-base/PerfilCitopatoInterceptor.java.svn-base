 ...
 public class PerfilCitopatoInterceptor
   implements Interceptor
 {
   ...
   {
     return this.usuarioDaSessao.getAcessoCitopato().charValue() == 'Y';
   }
 }

/* Location:           D:\UFPE\LIKA\desenvolvimento\hpv\trunk\hpv\ImportedClasses\
 * Qualified Name:     br.com.lika.hpv.interceptor.PerfilCitopatoInterceptor
