 ...
 public class PerfilViralHcvInterceptor
   implements Interceptor
 {
   ...
   {
     return this.usuarioDaSessao.getAcessoViralHcv().charValue() == 'Y';
   }
 }

/* Location:           D:\UFPE\LIKA\desenvolvimento\hpv\trunk\hpv\ImportedClasses\
 * Qualified Name:     br.com.lika.hpv.interceptor.PerfilViralHcvInterceptor
