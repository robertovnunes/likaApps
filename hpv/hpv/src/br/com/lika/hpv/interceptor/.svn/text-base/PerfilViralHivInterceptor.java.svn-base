 ...
 public class PerfilViralHivInterceptor
   implements Interceptor
 {
   ...
   {
     return this.usuarioDaSessao.getAcessoViralHiv().charValue() == 'Y';
   }
 }

/* Location:           D:\UFPE\LIKA\desenvolvimento\hpv\trunk\hpv\ImportedClasses\
 * Qualified Name:     br.com.lika.hpv.interceptor.PerfilViralHivInterceptor
