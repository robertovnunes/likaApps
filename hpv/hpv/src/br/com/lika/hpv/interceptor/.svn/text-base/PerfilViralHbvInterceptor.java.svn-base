 ...
 public class PerfilViralHbvInterceptor
   implements Interceptor
 {
   ...
   {
     return this.usuarioDaSessao.getAcessoViralHbv().charValue() == 'Y';
   }
 }

/* Location:           D:\UFPE\LIKA\desenvolvimento\hpv\trunk\hpv\ImportedClasses\
 * Qualified Name:     br.com.lika.hpv.interceptor.PerfilViralHbvInterceptor
