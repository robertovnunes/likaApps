 ...
 public class PerfilViralHpvInterceptor
   implements Interceptor
 {
   ...
   {
     return this.usuarioDaSessao.getAcessoViralHpv().charValue() == 'Y';
   }
 }

/* Location:           D:\UFPE\LIKA\desenvolvimento\hpv\trunk\hpv\ImportedClasses\
 * Qualified Name:     br.com.lika.hpv.interceptor.PerfilViralHpvInterceptor
