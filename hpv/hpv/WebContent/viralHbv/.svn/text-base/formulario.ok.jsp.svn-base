	...
	<body>
	    <div id="container">
			...
			<div id="content">
					...
					<h2 style="">HBV</h2><br>
					<h2 style="margin-left: 20px;"><u>Viral - HBV</u></h2>
					<br>
				<form action="viralHbv.add.logic" method="post">
					<input type="hidden" name='laudoHbv.id' value="${laudoHbv.id}">
					<input type="hidden" name='laudoHbv.formulario.id' value='${formulario.id}'>
					...
					<table class=block style="width: 100%;">
						...
						<tr> 
							...
							<td class=block>
								<input type=text name='laudoHbv.unidadeSaudeFamilia' value="${laudoHbv.unidadeSaudeFamilia}" style="width: 300px;" maxlength="120"/>
							</td>
						</tr>
						<tr> 
							<td><br></td>
						...
						<tr>
							...
							<td class=block>
								<input type="text" name='laudoHbv.resultado' value="${laudoHbv.resultado}" style="width: 100%;" maxlength="100"/>
							</td>
						</tr>
						<tr>
							<td class=block>
							...
							<td class=block>
								<input type='text' name='laudoHbv.dataColeta' value='${laudoHbv.dataColeta}' onkeyup="this.value=formateadata(this.value);" style="width: 100%;"/>
							</td>
						</tr>
						<tr>
							<td class=block>Data da entrega</td>
							<td class=block>
								<input type='text' name='laudoHbv.dataEntrega' value='${laudoHbv.dataEntrega}' onkeyup="this.value=formateadata(this.value);" style="width: 80px;"/>
							</td>
						</tr>
						<tr>
							<td class=block>Código</td>
							<td class=block>
								<input type='text' name='laudoHbv.codigo' value='${laudoHbv.codigo}' style="width: 80px;" />								
							</td>
						</tr>
						...
						<tr>
							...
							<td class=block>
								<textarea name='laudoHbv.observacoes' style="width: 100%;height: 100px;" onkeyup="this.value=tamanho(this.value,150);">${laudoHbv.observacoes}</textarea>
