	...
	<body>
	    <div id="container">
			...
			<div id="content">
					...
					<h2 style="">11. Exames</h2><br>
					<h2 style="margin-left: 20px;">i. <u>Viral</u></h2>
					<br>
				<form action="viral.addFormularioExameViral.logic" method="post">
					...
					<table class=block style="width: 100%;">
						...
						<tr> 
							<td class=block colspan="2"><b>HCV</b></td>
						</tr>
						<tr>
							<td class=block> Resultado</td>
							<td class=block>		
									<input type="text" name='hcvResultado' style="width: 100%;" maxlength="120"/>
							</td>
						</tr>
						<tr>
							<td class=block>Data da coleta</td>
							<td class=block>
								<input type='text' onkeyup="this.value=formateadata(this.value);" style="width: 80px;"/>
							</td>
						</tr>
						<tr>
							<td class=block>Data da entrega</td>
							<td class=block><input type='text' onkeyup="this.value=formateadata(this.value);" style="width: 80px;"/></td>
						</tr>
						<tr>
							<td class=block>Código</td>
							<td class=block>
						...
						<tr>
							<td class=block>Observações</td>
							<td class=block><textarea style="width: 100%;height: 40px;"></textarea>
						</tr>
						<tr> 
							<td><br></td>
							<td></td>
						...
						<tr> 
							<td class=block colspan="2"><b>HBV</b></td>
						</tr>
						<tr>
							<td class=block> Resultado</td>
							<td class=block>		
									<input type="text" name='hbvResultado' />
							</td>
						</tr>
						<tr>
							<td class=block>
						...
						<tr> 
							<td class=block colspan="2"><b>HPV</b></td>
						</tr>
						<tr>
							<td class=block> Resultado</td>
							<td class=block>		
									<input type="text" name='hpvResultado' />
							</td>
						</tr>
						<tr>
							<td class=block>
						...
						<tr>
							<td class=block>Observa&ccedil;&otilde;s</td>
							<td class=block><textarea style="width: 100%;height: 40px;"></textarea>
						</tr>
						<tr> 
							<td class=block><b>HPV - gen&oacute;tipo</b></td>
							<td class=block>									
									<input type="text" name='hpv_genotipo' onkeyup="this.value=doDecimal(this.value);" maxlength="3"/>
							</td>
						</tr>
						<tr> 
							<td><br></td>
						...
						<tr> 
							<td class=block colspan="2"><b>S&iacute;filis</b></td>
						</tr>
						<tr>
							<td class=block> Resultado</td>
							<td class=block>		
									<input type="text" name='sifilis' />
							</td>
						</tr>
						<tr>
							<td class=block>
						...
						<tr> 
							<td class=block colspan="2"><b>Clam&iacute;dia</b></td>
						</tr>
						<tr>
							<td class=block> Resultado</td>
							<td class=block>		
									<input type="text" name='clamidia' />
							</td>
						</tr>
						<tr>
							<td class=block>
