		...
		<script language="JavaScript" type="text/javascript" src="jscripts/MascaraValidacao.js"></script>     
         ...
         function atualizarDroga(){
				...
				if(selectEscolha.options[0].selected == false) {
					...
					if(jahEscolhido != ''){
						alert('Campo(s): '+jahEscolhido+' já adicionado(s)!');
					}
				
					
				}else {
				    window.alert("Selecione uma opção 11");
				}
				...
				if(texto != ''){
					...
					for (i = indexUltimo-1; i > 0; i--) {
						  if(selectEscolhido.options[i].value == texto){
							  jahInseriu = true;
							  alert('Comorbidade já adicionada');
						   }
				   }
					if(jahInseriu == false){
			...
			function addOutasAntecedentes(){
				...
				if(texto != ''){
					...
					for (i = indexUltimo-1; i > 0; i--) {
						  if(selectEscolhido.options[i].value == texto){
							  jahInseriu = true;
							  alert('Antecedente já adicionada');
						   }
				   }
					if(jahInseriu == false){
					 	selectEscolhido.options[selectEscolhido.options.length] = new Option(texto);
...
<div class="desabilitar-form" style="height:3000px;"></div>	
			 			...
			 			<tr>
			 				<td id="resumoPsiquica">
			 					<c:forEach items="${caracteristicas}" var="caracteristica" varStatus="index">
									<c:set var="contemSubString" value="${fn:contains('Agressividade;Bulimia nervosa;Delinquência;Desantenção;Disfemia;Destrutividade;Emtartamudez;Encoprese funcional;Enurese funcional;Hábitos anônimos de consumo de alimentos;Identidade sexual conflituoso;Impulsividade;Inanição;Medos neo-realistas;Tiques;Negatividade;Chorosa(o);Ansiedade Crônica;' , caracteristica)}"></c:set>
							...
							<td>
								<select name="escolhaCaracteristicas" id="escolhaCaracteristicas" size="10" style="width:300px" multiple="multiple">
							        ...
							        <option value="Agressividade" <c:if test="${contemSubString == true}">selected="selected" </c:if> >Agressividade</option>
					         		...
					         		<c:set var="contemSubString" value="${fn:contains(antecedentes.caracteristicasComportamentais , 'Ansiedade Crônica')}"></c:set>	
							        <option value="Ansiedade Crônica" <c:if test="${contemSubString == true}">selected="selected" </c:if>>Ansiedade Crônica</option>
							        ...
							        <c:set var="contemSubString" value="${fn:contains(antecedentes.caracteristicasComportamentais , 'Delinquência')}"></c:set>
							        <option value="Delinquência"<c:if test="${contemSubString == true}">selected="selected" </c:if> >Delinqu&ecirc;ncia</option>
							       
							        <c:set var="contemSubString" value="${fn:contains(antecedentes.caracteristicasComportamentais , 'Desantenção')}"></c:set>
							        <option value="Desantenção"<c:if test="${contemSubString == true}">selected="selected" </c:if> >Desanten&ccedil;&atilde;o</option>
							        ...
							        <c:set var="contemSubString" value="${fn:contains(antecedentes.caracteristicasComportamentais , 'Hábitos anônimos de consumo de alimentos')}"></c:set>
							        <option value="Hábitos anônimos de consumo de alimentos"<c:if test="${contemSubString == true}">selected="selected" </c:if> >H&aacute;bitos anônimos de consumo de alimentos</option>
							        ...
							        <c:set var="contemSubString" value="${fn:contains(antecedentes.caracteristicasComportamentais , 'Inanição')}"></c:set>
							        <option value="Inanição"<c:if test="${contemSubString == true}">selected="selected" </c:if> >Inani&ccedil;&atilde;o</option>
					...
					<div id="Marcos">
							...
							<tr>
	                            ...
	                            <td>
	                               <select name="gravidez" onchange="gravidezEscolheu();">
									...
									<option value="Não Planejada" <c:if test="${antecedentes.gravidez == 'Não Planejada'}">selected="selected"</c:if>>N&atilde;o Planejada</option>
								</select>
	                    	 </td>
	                       </tr>
							<tr>
	                            ...
	                            <td>
				                     <select name="parto" onchange="partoEscolheu();">
										...
										<option value="Vaginal com fócerps" <c:if test="${antecedentes.parto == 'Vaginal com fócerps'}">selected="selected"</c:if>>Vaginal com f&oacute;rceps</option>
										<option value="Cesárea" <c:if test="${antecedentes.parto == 'Cesárea'}">selected="selected"</c:if>>Ces&aacute;rea</option>
									</select>
								</td>
	                        </tr>
	                       </table>
                 	...
                 	<div class="titulo">Historico Obstétrico</div>
  					<div class="sessao">
                    <table>
						<tr>
							<td colspan="5">
						...
						<tr>
							...
							<td>
								<label>Sim <input onclick="escolheuSim('tbqualMotora');" type="radio" id="simMotora" name="motora" <c:if test="${antecedentes.histObs_motora != 'Não' && antecedentes.histObs_motora != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input onclick="escolheuNao('tbqualMotora');" type="radio" id="naoMotora" name="motora" <c:if test="${antecedentes.histObs_motora == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
								Qual: <input type="text" size="15" <c:if test="${antecedentes.histObs_motora == 'Não'}">disabled="disabled"</c:if> id="tbqualMotora" name="tbqualMotora" value="<c:out value="${antecedentes.histObs_motora}"></c:out>" />
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<label>Sim <input type="radio" onclick="escolheuSim('tbqualLinguagem');"  id="naoMotora" name="linguage" <c:if test="${antecedentes.histObs_linguagem != 'Não' && antecedentes.histObs_linguagem != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input type="radio" id="naoMotora" onclick="escolheuNao('tbqualLinguagem');"  name="linguage" <c:if test="${antecedentes.histObs_linguagem == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
								Qual: <input type="text" size="15" <c:if test="${antecedentes.histObs_linguagem == 'Não'}">disabled="disabled"</c:if> id="tbqualLinguagem" name="tbqualLinguagem" value="<c:out value="${antecedentes.histObs_linguagem}"></c:out>"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<label>Sim <input type="radio" id="naoMotora" onclick="escolheuSim('tbqualVisao');"  name="visao" <c:if test="${antecedentes.histObs_visao != 'Não' && antecedentes.histObs_visao != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input type="radio" id="naoMotora" onclick="escolheuNao('tbqualVisao');"  name="visao" <c:if test="${antecedentes.histObs_visao == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
								Qual: <input type="text" size="15" <c:if test="${antecedentes.histObs_visao == 'Não'}">disabled="disabled"</c:if> id="tbqualVisao" name="tbqualVisao" value="<c:out value="${antecedentes.histObs_visao}"></c:out>"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<label>Sim <input type="radio" id="naoMotora" onclick="escolheuSim('tbqualAudicao');"  name="audicao" <c:if test="${antecedentes.histObs_audicao != 'Não' && antecedentes.histObs_audicao != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input type="radio" id="naoMotora" onclick="escolheuNao('tbqualAudicao');"  name="audicao" <c:if test="${antecedentes.histObs_audicao == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
								Qual: <input type="text" size="15" <c:if test="${antecedentes.histObs_audicao == 'Não'}">disabled="disabled"</c:if> id="tbqualAudicao" name="tbqualAudicao" value="<c:out value="${antecedentes.histObs_audicao}"></c:out>"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<label>Sim <input type="radio" id="naoMotora" onclick="escolheuSim('tbqualPaladar');"  name="paladar" <c:if test="${antecedentes.histObs_paladar != 'Não' && antecedentes.histObs_paladar != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input type="radio" id="naoMotora" onclick="escolheuNao('tbqualPaladar');"  name="paladar" <c:if test="${antecedentes.histObs_paladar == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
								Qual: <input type="text" size="15" <c:if test="${antecedentes.histObs_paladar == 'Não'}">disabled="disabled"</c:if> id="tbqualPaladar" name="tbqualPaladar" value="<c:out value="${antecedentes.histObs_paladar}"></c:out>"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<label>Sim <input type="radio" id="naoMotora" onclick="escolheuSim('tbqualOlfato');"  name="olfato" <c:if test="${antecedentes.histObs_olfato != 'Não' && antecedentes.histObs_olfato != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input type="radio" id="naoMotora" onclick="escolheuNao('tbqualOlfato');"  name="olfato" <c:if test="${antecedentes.histObs_olfato == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
								Qual: <input type="text" size="15" <c:if test="${antecedentes.histObs_olfato == 'Não'}">disabled="disabled"</c:if> id="tbqualOlfato" name="tbqualOlfato" value="<c:out value="${antecedentes.histObs_olfato}"></c:out>"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<label>Sim <input type="radio" id="naoMotora" onclick="escolheuSim('tbqualTato');"  name="tato" <c:if test="${antecedentes.histObs_tato != 'Não' && antecedentes.histObs_tato != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input type="radio" id="naoMotora" onclick="escolheuNao('tbqualTato');"  name="tato" <c:if test="${antecedentes.histObs_tato == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
								Qual: <input type="text" size="15"  <c:if test="${antecedentes.histObs_tato == 'Não'}">disabled="disabled"</c:if> id="tbqualTato" name="tbqualTato" value="<c:out value="${antecedentes.histObs_tato}"></c:out>"/>
							</td>
						</tr>
						<tr>
							<td colspan="5">
						...
						<tr>
							...
							<td>
								<label>Sim <input type="radio" id="naoMotora" onclick="escolheuSim('tbqualOutros');"  name="outros"  <c:if test="${antecedentes.histObs_outros != 'Não' && antecedentes.histObs_outros != null}">checked="checked"</c:if>/></label> 
							</td>
							<td>
								<label>N&atilde;o <input type="radio" id="naoMotora" onclick="escolheuNao('tbqualOutros');"  name="outros" <c:if test="${antecedentes.histObs_outros == 'Não'}">checked="checked"</c:if>/></label> 
							</td>	
							<td>
						...
						<tr>
							<td colspan="5">
								...
								<label>Péssimo <input type="radio" <c:if test="${antecedentes.adolescencia_relacionamentoOutros == 'Péssimo'}">checked="checked"</c:if> name="relacionamentoAdolecentes" value="Péssimo"/></label>
							</td>
						</tr>
						<tr>
							<td colspan="5">
						...
						<tr>
							<td colspan="5">
								...
								<label>Péssima <input type="radio" <c:if test="${antecedentes.adolescencia_autoridades == 'Péssima'}">checked="checked"</c:if>  name="relacAutoridades" value="Péssima"/></label>
							</td>
						</tr>
						<tr>
							<td colspan="5">
						...
						<tr>
							<td colspan="5">
								Em rela&ccedil;&atilde;o às notas escolares							
							</td>
						</tr>
						<tr>
							<td colspan="5">
								<label>&Oacute;timas <input type="radio" name="notasAdolec" <c:if test="${antecedentes.adolescencia_notas == 'Ótimas'}">checked="checked"</c:if> value="Ótimas"/></label>
								...
								<label>Péssimas <input type="radio" name="notasAdolec" value="Péssimas" <c:if test="${antecedentes.adolescencia_notas == 'Péssimas'}">checked="checked"</c:if>/></label>
							</td>
						</tr>
						<tr>
							<td colspan="5">
						...
						<tr>
							<td colspan="5">
								Uso de substâncias il&iacute;citas
							</td>
						</tr>
						<tr>
							<td colspan="5">
						 			...
						 			<tr>
						 				<td id="resumo">
						 					<c:forEach items="${substanciasIlicitas}" var="substancia" varStatus="index">
													<c:set var="contemSubString" value="${fn:contains('Maconha;Heroína;Crack;Cocaína;Ecstasy;Anfetamina;Solventes;Barbitúricos;LSD;Ópio;Cogumelos Alucinógenos;' , substancia)}"></c:set>
													<c:if test="${contemSubString == false}">
								...
								<table class="mytable" align="center">
									<tr>
											...
											<select name="escolhaDroga" id="escolhaDroga" size="10" style="width:300px" multiple="multiple">
										        ...
										        <c:set var="contemSubString" value="${fn:contains(antecedentes.adulto_substanciasIlicitasSelecionadas , 'Heroína')}"></c:set>
												<option value="Heroína" <c:if test="${contemSubString == true}">selected="selected"</c:if>>Hero&iacute;na</option>
												...
												<c:set var="contemSubString" value="${fn:contains(antecedentes.adulto_substanciasIlicitasSelecionadas , 'Cocaína')}"></c:set>
												<option value="Cocaína" <c:if test="${contemSubString == true}">selected="selected"</c:if>>Coca&iacute;na</option>
												...
												<c:set var="contemSubString" value="${fn:contains(antecedentes.adulto_substanciasIlicitasSelecionadas , 'Barbitúricos')}"></c:set>
												<option value="Barbitúricos" <c:if test="${contemSubString == true}">selected="selected"</c:if>>Barbitúricos</option>
												...
												<c:set var="contemSubString" value="${fn:contains(antecedentes.adulto_substanciasIlicitasSelecionadas , 'Ópio')}"></c:set>
												<option value="Ópio" <c:if test="${contemSubString == true}">selected="selected"</c:if>>&Oacute;pio</option>
												
												<c:set var="contemSubString" value="${fn:contains(antecedentes.adulto_substanciasIlicitasSelecionadas , 'Cogumelos Alucinógenos')}"></c:set>
												<option value="Cogumelos Alucinógenos" <c:if test="${contemSubString == true}">selected="selected"</c:if>>Cogumelos Alucin&oacute;genos</option>
										    </select>
										</td>
										<td>
