...
<form method="post" action="http://tinymce.moxiecode.com/dump.php?example=true">
	<h3>Adendo</h3>
	<b>Autor:</b> <c:out value="${adendo.autor.nome}"></c:out>
	<b>Data:</b>  <c:out value="${adendo.dataHoraFormatada}"></c:out>
	<br /><br />
	<!-- Gets replaced with TinyMCE, remember HTML in a textarea should be encoded -->
	<textarea id="elm1" name="adendo" rows="15" maxlength="255" cols="80" style="width: 100%" disabled="disabled" readonly="readonly">
		  <c:out value="${adendo.descricao}"></c:out>
	</textarea>
	<br /><br /><br />
