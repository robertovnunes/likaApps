                                ...
                                <div style="float:left;margin-right: 10px;">
                                    <font face="Arial">
                                        ...
                                        <select size="1" name="raca">
                                            ...
                                            <option value="INDÍGENA" <c:if test="${pacienteRet.raca == 'INDÍGENA'}">select="selected"</c:if>>IND&Iacute;GENA</option>
                                        </select>
                                    </font>
                                </div>
                                <div style="float:left;">
                                ...
                                <div style="float:left;margin-right: 10px;">
                                    <font face="Arial">
                                        ...
                                        <select size="1" name="estado_civil">
                                            ...
                                            <option value="VIÚVO" <c:if test="${pacienteRet.estadoCivil == 'VIÚVO'}">selected="selected"</c:if>>VI&Uacute;VO</option>
                                ...
                                <div style="float:left;margin-right: 10px;">
                                    <font face="Arial">
                                        ...
                                        <select size="1" name="religiao">
                                            ...
                                            <option value="CATÓLICA" <c:if test="${pacienteRet.religiao == 'CATÓLICA'}">selected="selected"</c:if>>CAT&Oacute;LICA</option>
                                            <option value="PROTESTANTE" <c:if test="${pacienteRet.religiao == 'PROTESTANTE'}">selected="selected"</c:if>>PROTESTANTE</option>
                                            <option value="ESPÍRITA" <c:if test="${pacienteRet.religiao == 'ESPÍRITA'}">selected="selected"</c:if>>ESP&Iacute;RITA</option>
                                ...
                                <div style="float:left;">
                                    <font face="Arial">
                                        ...
                                        <select size="1" name="escolaridade">
                                            ...
                                            <option value="Médio comp" <c:if test="${pacienteRet.escolaridade == 'Médio comp'}">selected="selected"</c:if>>M&eacute;dio comp</option>
                                            <option value="Médio incomp" <c:if test="${pacienteRet.escolaridade == 'Médio incomp'}">selected="selected"</c:if>>M&eacute;dio incomp</option>
