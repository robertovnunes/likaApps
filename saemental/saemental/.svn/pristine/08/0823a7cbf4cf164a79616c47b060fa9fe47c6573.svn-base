...
<div class="desabilitar-form" style="height:2000px;"></div>	
	...
	<table>
		...
		<tr>
			...
			<td align="right">
					Em pânico<input type="checkbox" id="estadoEmocionalEmPanico" name="estadoEmocionalEmPanico" <c:if test="${exame.estadoEmocionalEmPanico == true}"> checked="checked"</c:if>/>
			</td>
			<td align="right">
	...
	<table>
		...
		<tr>
			...
			<td align="left" width="100px">		
					<div align="right" style="float:left;">Adequado ao<br/>conteúdo</div>
	...
	<table>
		<tr>
			<td colspan="10" width="650px">
				<div class="titulo">Distúrbios</div>
  				 <div class="sessao"></div>
			</td>
		</tr>
		<tr>
	...
	<table>
		...
		<tr>
			...
			<td align="right" width="100px">		
					Fuga de idéias<input type="checkbox" id="formaDoPensamentoFugaDeIdeias" name="formaDoPensamentoFugaDeIdeias" <c:if test="${exame.formaDoPensamentoFugaDeIdeias == true}"> checked="checked"</c:if>/>
			</td>
			<td align="right" width="100px">		
	...
	<table>	
		<tr>
			<td colspan="10" width="650px">
				<div class="titulo">Conteúdo  do Pensamento</div>
  				 <div class="sessao"></div>
			</td>
		</tr>
		<tr>
