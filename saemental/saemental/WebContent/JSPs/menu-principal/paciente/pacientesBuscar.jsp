...
<head> 
 ...
 <script type="text/javascript">
	        ...
	        //	div.innerHTML = "<b>Usuário: </b>"+ '${usuario.nome}';
	        	...
	        	divnavegacao.innerHTML = "<a style='color: white;text-decoration: none;' href='<%=urlBase%>'>Home </a> :: <a style='color: white;text-decoration: none;' href='#'>Pacientes Buscar</a>";
        	}
        </script>
</head>
...
<div align='center' id="main-content" style="background-image: none !important;" >
		...
		<div style="margin-top:15px;">
           ...
           <div id="buscarPacientes">
                    ...
                    <h:form action="pacienteBuscar" >
                    	<h:hidden property="method" value="pacienteBuscar"/>   
                        <div align="center" style="height: 79px">
                            <label>
                                <input type="text" size="60" class="input-text" name="tfBusca" id="tfBusca" onkeypress=" return keyPress(event,this);" />
                            </label>
                            <input type="submit" value="Buscar" />
                            <br/><br/>
                            <label onclick="resetarForm();">
								Nome<input id="tipoDeBusca"  checked="checked" name="tipoDeBusca" type="radio" value="nome" />
							</label>
							<label onclick="resetarForm();">
								Nome da m&atilde;e<input id="tipoDeBusca"  name="tipoDeBusca" type="radio" value="mae"  />
							</label>
							<label onclick="resetarForm();">
								CPF<input id="tipoDeBusca"  name="tipoDeBusca" type="radio" value="cpf" />
							</label>
							<label onclick="resetarForm();">	
								Data de Nascimento<input id="tipoDeBusca"  name="tipoDeBusca" type="radio" value="data" />
							</label>
                        </div>
                      </h:form> 
                   
                        <p id="titulo-verm" style='margin-left: 350px;' align="left">Pacientes</p>
                    ...
                    <table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="700">
                       <thead>
	                        ...
	                        <th sort="date">Nascimento</th>
	                        <th sort="idade">Idade</th>
	                        <th sort="sexo">Sexo</th>
	                        <th sort="opcoes">Op&ccedil;&otilde;es</th>
               			 </tr>
       					 </thead>
       					<tbody>
       					
       					<c:forEach items="${pacientes}" var="paciente" varStatus="index">
       					 <tr>
                            ...
                            <td align="center" width="200">
                                <a href="paciente.do?method=mostrarTelaPacienteEditar&id=${paciente.id}" title="Alterar Cadastro do Paciente"><img src="imagens/edit.png" width="20" height="20" border="0" /></a>
								<a href="antendimento.do?method=antedimentosPaciente&id=${paciente.id}" title="Atendimentos do Paciente"><img src="imagens/folder.png" width="20" height="20" border="0" /></a>
