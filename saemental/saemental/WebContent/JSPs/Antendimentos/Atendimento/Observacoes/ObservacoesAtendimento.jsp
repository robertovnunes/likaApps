		 ...
		 <div id="conteudoNormal" align="left" style="height:700px; display:inline-block;">
		  ...
		  <div id="erroMsg">
               ...
               <font color="red"> 
                 ...
                 <br/> <br/><br/>
                <div id="buscarAdendo">
                    <form id="form" name="form" method="post" action="observacoesBuscar.do">
                    <input type="hidden" value="observacoesBuscar" name="method"/>
                        <div align="center" style="height: 60px">
                            ...
                            <label onclick="resetarForm();">
                                Autor<input name="tipoDeBusca" type="radio" checked="checked" value="autor"/>
                            </label>
                            <label onclick="resetarForm();">
                    ...
                    <h4 align="left" style="margin-left:80px;">Adendos</h4>
                    <table id="demoTable" style="border: 1px solid #ccc;" cellspacing="0" width="700">
                       <thead>
               			 <tr>
	                       <th sort="autor">Autor</th>
                            <th sort="data">DataHora</th>
                            <th sortn="tipo">Selecionar</th>
	                 	</tr>
	                 	</thead>
	                 
                   <tbody>
						<c:forEach items="${adendos}" var="adendo" varStatus="index">
                        <tr>
                            <td align="center">
                                <c:out value="${adendo.autor.nome}"></c:out>
                            </td>
                            <td align="center">
                                 <c:out value="${adendo.dataHoraFormatada}"></c:out>
                            </td>
                            <td align="center">
                                <a target="_blank" href="adendoSelect.do?method=selecionarAdendo&id=<c:out value="${adendo.id}"></c:out>">Selecionar</a>
                            </td>
                        </tr>
                        </c:forEach>
                     </tbody>
       			 ...
       			 <div style="margin-left:40%;">
       			 	 <input type="button" value="Adicionar Adendo" id="button"/>
       			 </div>
                </div>
...
<div id="popupContact">
		...
		<h1>Adicionar Adendo</h1>
		<p id="contactArea">
			<form name="adendoAdd" method="post" action="adendoAdd.do">
    	 		 <h:hidden property="method" value="adicionarAdendo"/>   
				<textarea id="elm1" name="adendo" rows="15" cols="80" style="width: 100%"  >
				</textarea>
				<br/><br/>
