				 ...
				 <br/><br/>
				  ...
				  Cor e Aspectos <br/>
                                L&iacute;mpida<input name="corlimpida" type="checkbox" <c:if test="${exame.corlimpida == true}"> checked="checked"</c:if>/>
                                 Colúrica<input type="checkbox" name="corcolurica" <c:if test="${exame.corcolurica == true}"> checked="checked"</c:if>/>
		            ...
		            Altera&ccedil;&otilde;es miccionais<br/>
		                                 Oligúria<input type="checkbox" name="miccionaisoliguria" <c:if test="${exame.miccionaisoliguria == true}"> checked="checked"</c:if>/>
		                                 Disúria<input type="checkbox" name="micccionaisdisuria" <c:if test="${exame.micccionaisdisuria == true}"> checked="checked"</c:if>/>
		                                 Anúria<input type="checkbox" name="miccionaisanuria"<c:if test="${exame.miccionaisanuria == true}"> checked="checked"</c:if> />
		                                 Polaciúria<input type="checkbox" name="miccionaispolaciuria"<c:if test="${exame.miccionaispolaciuria == true}"> checked="checked"</c:if> /><br/>
		                                 Hematúria<input type="checkbox" name="miccionaishematuria" <c:if test="${exame.miccionaishematuria == true}"> checked="checked"</c:if>/>
		                                 ...
		                                 Poliúria <input type="checkbox" name="miccionaispoliuria" <c:if test="${exame.miccionaispoliuria == true}"> checked="checked"</c:if>/>
		                                 Piúria<input type="checkbox" name="miccionaispiuria"<c:if test="${exame.miccionaispiuria == true}"> checked="checked"</c:if> />
		           	<br/><br/>
