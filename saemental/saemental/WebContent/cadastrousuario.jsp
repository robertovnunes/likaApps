...
<link href="Css/dropdown.css" media="screen" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    <body>
			...
			<h:form action="usuarioAlunoAdd" style=" width:80%;" >
                 <h:hidden property="method" value="usuarioAlunoAdd"/>   
                 <input type="hidden" value="usuarioAlunoAdd" name="acao"></input>
                        ...
                        <tr>
                            <td style="width:900px;padding-top:10px;">
								...
								<div style="float:left;">
                                    <font face="Arial">
                                        Email
										<input id="telefone" name="telefone" size="38" value="<c:out value="${usuarioRet.telefone}"></c:out>" maxlength="70"  />
                                    </font>
                                </div>
                                <div style="float:left;">
                                    <font face="Arial">
						...
						<tr>
							<td>
								<div>
		                            ...
		                            <input type="text" size="10" maxlength="10" name="login" value="<c:out value="${usuarioRet.login}"></c:out>" /> 
									Senha
									<font color="red">
		                                *
		                            </font>
