...
<div id="menu_sup">
	...
	<input type="button" value="Questionário Aluno" class="button" onClick="javascript:window.open('https://spreadsheets.google.com/viewform?formkey=dG1nSGpKdldVQWctdG5SbHpTNjFYWlE6MA', '_blank');"  />
	</c:if>

	<c:if test="<%= questionarioTutor %>">
	<input type="button" value="Questionário Tutor" class="button" onClick="javascript:window.open(' https://spreadsheets.google.com/viewform?formkey=dGZwRWVnXzNvSUxuSG83WV9NWjk5bVE6MA', '_blank');" />
	</c:if>
