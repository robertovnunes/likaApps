	...
	<div id="corpo">
		...
		<div id="conteudo">
			...
			<div id="miolo">
				...
				<h4>Planejamento | Palavra-Chave</h4>
					...
					<div style="margin:25px;">
						<c:if test="${empty problema.palavrasChave}">
							 ...
							 <table class="dados" align="center">
					  			<tr>
	  				  				<td class="content1">
	  				  					Nenhuma palavra-chave foi inserida. 
										
										<c:if test="${problema.aberto == 0}">
											<br>Para adicionar uma palavra-chave, clique em Adicionar.
										</c:if>
									</td>
								</tr>
							</table>
						...
						<c:if test="${not empty problema.palavrasChave}">
							...
							<display:table id="palavraChave" name="${problema.palavrasChave}">
								<display:column title="Palavra-Chave" property="palavra" style="width: 350px;"/>
