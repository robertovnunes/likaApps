...
<html>
	...
	<body>
		...
		<div id="menu_sup">
			...
			<input type="button" value="Questionario Tutor" class="button" onClick="javascript:window.open('http://spreadsheets.google.com/viewform?formkey=dFFmM1hvZDMwOTA2MFRSWXp2VFR4N2c6MA', '_blank');" />
			</c:if>
			...
			<input type="button" value="Ajuda" class="button" onclick="http://www.google.com" /> 
