...
<div id="topo"><img src="images/topoFonteRodrigo2BorboletasAlinhadas.png" width="778" height="107"
	alt="Cenas - cenários de aprendizagem em saúde" style="margin: 1px;" /></div>
<div id="branco">
<div id="texto">
<h2>CenAS</h2>
...
<table class="login">
	...
	<tr>
		<td>Login</td>
		<td><input type="text" name="usuario.login" class="logon" /></td>
	</tr>
		<tr>
		<td>Senha</td>
		<td><input type="password" name="usuario.senha" class="logon" /></td>
	</tr>
	<tr>
		<td></td>
		<td align="right">
	...
	<tr>
		<td align="right"><a href="esqueceusenha.recuperarsenha.logic">Esqueceu</a></td>
		<td align="left"><a href="esqueceusenha.recuperarsenha.logic">sua senha?</a></td>
	</tr>	
</table>
