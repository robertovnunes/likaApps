 	...
 	<div id="corpo"> 
		...
		<div id="conteudo">			
			...
			<div id="participantes" align="center">
				${fs:listarNomes(problema.equipe.alunos)}, ${problema.equipe.tutor.nome}<br/><br/>	 
			</div>
			<div align="center">
			...
			<c:forEach var="materialGrafico" items="${problema.materiaisGrafico}">
				<p align="center">
					<img src="cconhecimento.mostraImagem.logic?materialGrafico.idMaterialGrafico=${materialGrafico.idMaterialGrafico}" width="350px"/><br/>
