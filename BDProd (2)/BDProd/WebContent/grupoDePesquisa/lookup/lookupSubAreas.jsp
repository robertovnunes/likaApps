...
<f:subview id="lookupSubAreas">
	...
	<!-- ui-dialog -->
	<div id="dialogSubAreas"
		title="Associar Sub Área de Pesquisa ao Grupo de Pesquisa"><h:form
		styleClass="niceform">
			...
			<rich:dataTable id="tabelaResultadoArea"
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true"
						onclick="jQuery('#dialogSubAreas').dialog('close')"
						oncomplete="#{rich:component('dsArea')}.last()" value="Selecionar"
						reRender="areas" actionListener="#{grupoHandler.adicionarArea}">
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			...
			<a4j:commandLink onclick="jQuery('#dialogSubAreas').dialog('close')">
