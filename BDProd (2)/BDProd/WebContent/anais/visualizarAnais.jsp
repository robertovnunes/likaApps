	...
	<div id="conteudoForm"><h:panelGrid columns="1">
		<h:panelGrid columns="1">
			<h:panelGroup>
				...
				<h:outputText value="#{publicacaoHandler.publicacaoAtual.titulo}"
		...
		<h:panelGrid columns="5">
			...
			<h:panelGroup>
				...
				<h:outputText value="#{publicacaoHandler.publicacaoAtual.tipo}"
					styleClass="visualizar_texto" />

				<h:outputText value="Não informado" styleClass="nao_informado"
					rendered="#{publicacaoHandler.publicacaoAtual.tipo == ''}" />
			...
			<h:panelGroup>
				...
				<h:outputText value="#{publicacaoHandler.publicacaoAtual.natureza}"
					styleClass="visualizar_texto" />

				<h:outputText value="Não informado" styleClass="nao_informado"
					rendered="#{publicacaoHandler.publicacaoAtual.natureza == ''}" />
		...
		<h:panelGrid columns="11">
			...
			<h:panelGroup>
				...
				<h:outputText
					value="#{publicacaoHandler.publicacaoAtual.paginaFinal}"
					styleClass="visualizar_texto" />

				<h:outputText value="Não informado" styleClass="nao_informado"
					rendered="#{publicacaoHandler.publicacaoAtual.paginaFinal == ''}" />
		...
		<h:panelGrid columns="4">
			...
			<h:panelGroup>
				...
				<h:outputText value="#{publicacaoHandler.publicacaoAtual.fasciculo}"
					styleClass="visualizar_texto" />

				<h:outputText value="Não informado" styleClass="nao_informado"
					rendered="#{publicacaoHandler.publicacaoAtual.fasciculo == ''}" />
		...
		<h:panelGrid columns="1">
			...
			<h:panelGroup>
				...
				<h:outputText value="Não informado" styleClass="nao_informado"
					rendered="#{publicacaoHandler.publicacaoAtual.nomeEvento == ''}" />
			...
			<h:panelGroup>
				...
				<h:outputText value="Não informado" styleClass="nao_informado"
					rendered="#{publicacaoHandler.publicacaoAtual.tituloAnaisEvento == ''}" />
		...
		<h:panelGrid columns="5">
			...
			<h:panelGroup>
				...
				<h:outputText value="Não informado" styleClass="nao_informado"
					rendered="#{publicacaoHandler.publicacaoAtual.cidadeEvento == ''}" />
