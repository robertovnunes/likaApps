...
<f:subview id="visualizarPeriodico">
	...
	<div id="conteudoForm"><h:panelGrid columns="1">
	...
	</h:panelGrid> <h:panelGrid columns="9">
		<h:panelGroup>
	...
	</h:panelGrid> <h:panelGrid columns="5">
		<h:panelGroup>
		...
		<h:panelGroup>
			...
			<h:outputText value="#{publicacaoHandler.publicacaoAtual.ISSN}"
				styleClass="visualizar_texto" />

			<h:outputText value="Não informado" styleClass="nao_informado"
				rendered="#{publicacaoHandler.publicacaoAtual.ISSN == ''}" />
		</h:panelGroup>
		...
		<h:panelGroup>
			...
			<br />
			<h:outputText value="#{publicacaoHandler.publicacaoAtual.periodico}"
				styleClass="visualizar_texto" />

			<h:outputText value="Não informado" styleClass="nao_informado"
				rendered="#{publicacaoHandler.publicacaoAtual.periodico == ''}" />
		</h:panelGroup>
