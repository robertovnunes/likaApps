	...
	<div id="dialogCracha" title="Novo Crachá"><h:form
			...
			<div style="margin-bottom: 15px; margin-top: 15px;"><h:panelGroup>
				...
				<h:panelGroup>
					...
					<h:inputText id="numero" size="20"
						value="#{bolsistaProjetoHandler.novoCracha.numeroCracha}"
						maxlength="10" />
				</h:panelGroup>
				...
				<h:panelGroup>
					...
					<h:inputText id="emissao"
						value="#{bolsistaProjetoHandler.novoCracha.dataEmissao}" size="15"
				...
				<h:panelGroup>
					...
					<h:selectOneMenu id="situacaoCracha" style="width:150px;"
						value="#{bolsistaProjetoHandler.novoCracha.situacao}">
						...
						<a4j:support event="onchange" ajaxSingle="true"
							...
							action="#{bolsistaProjetoHandler.mudarSituacaoCracha}" />
				...
				<h:panelGroup id="des">
					...
					<h:inputText id="desligamento"
						binding="#{bolsistaProjetoHandler.dataDesligamento}"
						disabled="#{bolsistaProjetoHandler.novoCracha.situacao != 'Desligado'}"
						value="#{bolsistaProjetoHandler.novoCracha.dataDesligamento}"
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			...
			<a4j:commandLink onclick="jQuery('#dialogCracha').dialog('close')"
				action="#{bolsistaProjetoHandler.cancelarCracha}"
				reRender="panelCracha">
				<h:graphicImage value="../css/images/cancelar.png" />
			</a4j:commandLink>



			<a4j:commandLink action="#{bolsistaProjetoHandler.salvarCracha}"
