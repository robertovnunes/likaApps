	...
	<div id="dialogCracha" title="Novo Crachá"><h:form
		...
		<h:panelGroup id="pCracha">
			...
			<div style="margin-bottom: 15px; margin-top: 15px;"><h:panelGroup>
				...
				<h:inputText id="nome" size="86"
					value="#{funcionarioHandler.funcionarioAtual.nome}" maxlength="60"
					disabled="true" />
				...
				<h:panelGroup>
					...
					<h:inputText id="numero" size="20"
						value="#{funcionarioHandler.novoCracha.numeroCracha}"
						maxlength="10" />
				</h:panelGroup>
				...
				<h:panelGroup>
					...
					<h:inputText id="emissao"
						value="#{funcionarioHandler.novoCracha.dataEmissao}" size="15"
				...
				<h:panelGroup>
					...
					<h:selectOneMenu id="situacaoCracha" style="width:150px;"
						value="#{funcionarioHandler.novoCracha.situacao}">
						...
						<a4j:support event="onchange" ajaxSingle="true"
							...
							action="#{funcionarioHandler.mudarSituacaoCracha}" />
				...
				<h:panelGroup id="des">
					...
					<h:inputText id="desligamento"
						binding="#{funcionarioHandler.dataDesligamento}"
						disabled="#{funcionarioHandler.novoCracha.situacao != 'Desligado'}"
						value="#{funcionarioHandler.novoCracha.dataDesligamento}"
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			...
			<a4j:commandLink onclick="jQuery('#dialogCracha').dialog('close')"
				action="#{funcionarioHandler.cancelarCracha}" reRender="panelCracha">
				<h:graphicImage value="../css/images/cancelar.png" />
			</a4j:commandLink>



			<a4j:commandLink action="#{funcionarioHandler.salvarCracha}"
