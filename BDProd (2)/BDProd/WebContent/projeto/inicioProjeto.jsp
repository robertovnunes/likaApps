...
<f:view>
	...
	<div id="page"><h:form>
		...
		<ul>
			...
			<h2>Opções</h2>
			<ul>
				<li><h:commandLink value="Novo Projeto"
					action="#{sessionHandler.navigation.novoProjeto}"
					actionListener="#{projetoHandler.novoProjeto}" /></li>
				<li><h:commandLink value="Relatório"
					action="#{sessionHandler.navigation.inicioRelatoriosProjeto}" /></li>
			</ul>
			</li>
		</ul>
		</div>
		...
		<div id="content"><a4j:region id="regiao">
			...
			<h:panelGroup id="campo">
				...
				<a4j:commandButton id="botaoBuscar" value="Buscar"
					action="#{projetoHandler.consultar}" reRender="panel"
					onclick="this.disabled=true" oncomplete="this.disabled=false" />


			</h:panelGroup> <h:selectOneRadio value="#{projetoHandler.tipoSelecionado}">
				<f:selectItems value="#{projetoHandler.tiposDePesquisas}" />
				<a4j:support reRender="campo" event="onclick"
					action="#{projetoHandler.limparConsulta}" ajaxSingle="true" />
			...
			<a4j:outputPanel id="panel">
				...
				<h:panelGroup rendered="#{not empty projetoHandler.projetos }">
					<div class="titulo" style="margin-left: 15px; margin-bottom: 15px">
					<h:outputText value="Projetos" /></div>

					<div style="margin-left: 10px;"><rich:dataTable
						id="tabelaResultado" value="#{projetoHandler.projetos}"
						var="projeto" cellpadding="2" cellspacing="2" style="width:600px"
						rows="10" styleClass="mytable">
						<rich:column id="nome">
							<f:facet name="header">
								<h:outputText value="Nome"></h:outputText>
							</f:facet>
							<div style="width: 520px"><h:outputText
								value="#{projeto.nome}"></h:outputText></div>
						</rich:column>
						...
						<rich:column id="opcoes">
							...
							<h:commandLink
								action="#{sessionHandler.navigation.visualizarProjeto}"
								actionListener="#{projetoHandler.carregarProjeto}">
								<f:attribute name="idProjeto" value="#{projeto.idProjeto}" />
								<h:graphicImage value="../images/editar4.png"
									style="border:none;" title="Editar Projeto"
									alt="Editar Projeto" width="17" height="17"></h:graphicImage>
