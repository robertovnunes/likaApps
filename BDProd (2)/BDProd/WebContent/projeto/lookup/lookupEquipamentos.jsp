...
<f:subview id="lookupEquipamentos">
	...
	<!-- ui-dialog -->
	<div id="dialogEquipamentos"
		title="Associar um Equipamento ao Laboratório"><h:form
		styleClass="niceform">
		...
		<h:panelGroup>
			...
			<a4j:commandButton value="Buscar" reRender="novoEquipamento"
				action="#{equipamentoHandler.consultar}" />
		</h:panelGroup></div>


		<a4j:outputPanel id="novoEquipamento">
			...
			<rich:dataTable id="tabelaResultadoEquipamento"
				value="#{equipamentoHandler.equipamentos}" var="equipamento"
				cellpadding="2" cellspacing="2" style="width:580px" rows="5"
				styleClass="mytable"
				rendered="#{!empty equipamentoHandler.equipamentos }">
				<rich:column id="nome">
					<f:facet name="header">
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true"
						onclick="jQuery('#dialogEquipamentos').dialog('close')"
						value="Selecionar" reRender="panelEquipamentos"
						actionListener="#{laboratorioHandler.adicionarEquipamento}">
						<f:attribute value="#{equipamento}" name="equipamento" />
					</a4j:commandLink></div>
				</rich:column>
