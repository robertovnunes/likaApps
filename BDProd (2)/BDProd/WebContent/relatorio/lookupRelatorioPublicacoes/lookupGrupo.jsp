...
<body>
<f:subview id="lookupGrupo">




	<!-- ui-dialog -->
	<div id="dialogGrupo" title="Escolher um Grupo de Pesquisa"><h:form
		styleClass="niceform">
		...
		<h:panelGroup>
			...
			<a4j:commandButton value="Buscar" reRender="novoGrupo"
				action="#{grupoHandler.listarPorNome}" />
		</h:panelGroup></div>


		<a4j:outputPanel id="novoGrupo">
			...
			<rich:dataTable id="tabelaResultadoResp"
				value="#{grupoHandler.grupos}" var="grupo" cellpadding="2"
				cellspacing="2" style="width:580px" rows="5" styleClass="mytable"
				rendered="#{!empty grupoHandler.grupos }">
				<rich:column id="nome">
					<f:facet name="header">
						<h:outputText value="Nome"></h:outputText>
					</f:facet>
					<div style="width: 450px"><h:outputText value="#{grupo.nome}"></h:outputText></div>
				</rich:column>
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true" onclick="jQuery('#dialogGrupo').dialog('close')"
						value="Selecionar" reRender="panelGrupo"
						actionListener="#{relatorioPublicacaoHandler.selecionarGrupo}">
						<f:attribute value="#{grupo}" name="grupo" />
					</a4j:commandLink></div>
				</rich:column>
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			...
			<a4j:commandLink onclick="jQuery('#dialogGrupo').dialog('close')">
