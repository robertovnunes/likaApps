...
<f:subview id="lookupTitulacao">
	...
	<!-- ui-dialog -->
	<div id="dialogTitulacao" title="Adicionar Titulação ao Aluno"><h:form
		styleClass="niceform">
			...
			<h:panelGrid columns="5" width="100%">
				<h:panelGroup>
					...
					<h:selectOneMenu id="tit" style="width:150px;"
						value="#{alunoHandler.titulacaoAdicionada.titulacao}">
				...
				<h:panelGroup>
					...
					<br />
					<h:inputText id="curso" style="width:240px;" maxlength="100"
						value="#{alunoHandler.titulacaoAdicionada.curso}" />
				</h:panelGroup>

				<h:panelGroup>
					<h:outputLabel value="Instituição:" for="inst" />
					<br />
					<h:inputText id="inst" style="width:220px;" maxlength="100"
						value="#{alunoHandler.titulacaoAdicionada.instituicao}" />
				</h:panelGroup>
				
				<h:panelGroup>
					<h:outputLabel value="Início:" for="inicio" />
					<br />
					<h:inputText id="inicio" style="width:50px;" maxlength="4"
						value="#{alunoHandler.titulacaoAdicionada.inicio}"
				...
				<h:panelGroup>
					...
					<h:inputText id="conclusao" style="width:50px;" maxlength="4"
						value="#{alunoHandler.titulacaoAdicionada.conclusao}"
						onkeypress="mascara(this,soNumeros)" />
				</h:panelGroup>
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			...
			<a4j:commandLink onclick="jQuery('#dialogTitulacao').dialog('close')"
				action="#{alunoHandler.adicionarTitulacao}"
