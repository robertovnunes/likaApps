	...
	<div id="dialogCracha" title="Novo Crachá"><h:form
		...
		<h:panelGroup id="pCracha">
			<div style="margin-bottom: 15px; margin-top: 15px;"><h:panelGroup>
				...
				<h:inputText id="nome" size="86"
					value="#{pesquisadorHandler.pesquisadorAtual.nome}" maxlength="60"
					disabled="true" />
				...
				<h:panelGroup>
					...
					<h:inputText id="numero" size="20"
						value="#{pesquisadorHandler.novoCracha.numeroCracha}"
						maxlength="10" />
				</h:panelGroup>
				...
				<h:panelGroup>
					...
					<h:inputText id="emissao"
						value="#{pesquisadorHandler.novoCracha.dataEmissao}" size="15"
				...
				<h:panelGroup>
					...
					<h:selectOneMenu id="situacaoCracha" style="width:150px;"
						value="#{pesquisadorHandler.novoCracha.situacao}">
						...
						<a4j:support event="onchange" ajaxSingle="true"
							...
							action="#{pesquisadorHandler.mudarSituacaoCracha}" />
				...
				<h:panelGroup id="des">
					...
					<h:inputText id="desligamento"
						binding="#{pesquisadorHandler.dataDesligamento}"
						disabled="#{pesquisadorHandler.novoCracha.situacao != 'Desligado'}"
						value="#{pesquisadorHandler.novoCracha.dataDesligamento}"
						size="15" maxlength="10" onkeypress="mascara(this,data)"
						converterMessage="Data no formato inválido. ex: 30/10/1987">
						<f:convertDateTime type="date" pattern="dd/MM/yyyy" />
					</h:inputText>
				</h:panelGroup>
		...
		<div align="center" style="margin-top: 10px"><h:panelGrid
			...
			<a4j:commandLink onclick="jQuery('#dialogCracha').dialog('close')"
				action="#{pesquisadorHandler.cancelarCracha}" reRender="panelCracha">
				<h:graphicImage value="../css/images/cancelar.png" />
			</a4j:commandLink>



			<a4j:commandLink action="#{pesquisadorHandler.salvarCracha}"
