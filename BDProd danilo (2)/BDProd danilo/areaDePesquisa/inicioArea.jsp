...
<f:view>
	...
	<div id="page"><h:form>
		...
		<ul>
			...
			<h2>Opções</h2>
			<ul>
				<li><h:commandLink value="Nova Área de Pequisa"
					action="#{sessionHandler.navigation.novoArea}"
					actionListener="#{areaHandler.novaArea}" /></li>
			</ul>
			</li>
		</ul>
		</div>
		...
		<div id="content"><a4j:region id="regiao">
			...
			<h:panelGroup id="campo">
				...
				<a4j:commandButton id="botaoBuscar" value="Buscar"
					action="#{areaHandler.listarAreaPorNome}" reRender="panel"
			...
			<a4j:outputPanel id="panel">
				...
				<h:panelGroup rendered="#{empty areaHandler.areas }">
					<div id="nenhum" align="center" style="color: red;"><h:outputText
						value="Nenhuma Área de Pesquisa econtrado. " /></div>
				</h:panelGroup>
				...
				<h:panelGroup rendered="#{not empty areaHandler.areas }">
					<div class="titulo" style="margin-left: 15px; margin-bottom: 15px">
					<h:outputText value="Áreas de Pesquisa" /></div>

					<div style="margin-left: 10px;"><rich:dataTable
						id="tabelaResultado" value="#{areaHandler.areas}" var="func"
						...
						<rich:column id="opcoes">
							...
							<h:commandLink
								action="#{sessionHandler.navigation.visualizarArea}"
								actionListener="#{areaHandler.carregarArea}">
								<f:attribute name="idArea" value="#{func.idAreaDePesquisa}" />

								<h:graphicImage value="../images/editar4.png"
									style="border:none;" title="Editar Área de Pesquisa"
									alt="Editar Área de Pesquisa" width="17" height="17"></h:graphicImage>
