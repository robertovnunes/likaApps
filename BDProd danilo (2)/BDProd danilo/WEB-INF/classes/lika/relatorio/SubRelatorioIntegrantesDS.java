 ...
 * @author Marcio
 */
public class SubRelatorioIntegrantesDS implements JRDataSource {
	...
	public SubRelatorioIntegrantesDS(List<Pessoa> dados) {
		this.dados = dados;
	...
	public Object getFieldValue(JRField campo) throws JRException {
		...
		if ("nome".equals(campo.getName())) {
			...
			valor = pessoa.getSituacao();
		} else if ("dataDesligamento".equals(campo.getName())) {
			if (pessoa.getDataDesligamento() != null) {
				DateFormat df = DateFormat.getDateInstance(DateFormat.MEDIUM,
						new Locale("pt", "BR"));

				valor = df.format(pessoa.getDataDesligamento());
			} else {
				valor = " - ";
			}
		}
