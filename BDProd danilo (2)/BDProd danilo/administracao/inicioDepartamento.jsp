...
<f:view>
	...
	<div id="page"><h:form>
		...
		<ul>
			...
			<h2>Opções</h2>
			<ul>
				<li><h:commandLink value="Novo Departamento"
					action="#{sessionHandler.navigation.novoDepartamento}"
					actionListener="#{adminHandler.novoDepartamento}" /></li>
		...
		<div id="content"><a4j:region id="regiao">
			...
			<h:panelGroup id="campo">
				...
				<a4j:commandButton id="botaoBuscar" value="Buscar"
					action="#{adminHandler.listarDepartamentos}" reRender="panel"
			...
			<a4j:outputPanel id="panel">
				...
				<h:panelGroup rendered="#{empty adminHandler.departamentos }">
					<div id="nenhum" align="center" style="color: red;"><h:outputText
						value="Nenhuma Departamento econtrada. " /></div>
				</h:panelGroup>
				...
				<h:panelGroup rendered="#{not empty adminHandler.departamentos }">
					<div class="titulo" style="margin-left: 15px; margin-bottom: 15px">
					<h:outputText value="Departamentos" /></div>

					<div style="margin-left: 10px;"><rich:dataTable
						id="tabelaResultado" value="#{adminHandler.departamentos}"
						var="dep" cellpadding="2" cellspacing="2" style="width:600px"
						rows="10" styleClass="mytable">
						<rich:column id="nome">
							<f:facet name="header">
								<h:outputText value="Departamento"></h:outputText>
							</f:facet>
							<div style="width: 420px"><h:outputText value="#{dep.nome}"></h:outputText></div>
						</rich:column>
						...
						<rich:column id="opcoes">
							...
							<h:commandLink
								action="#{sessionHandler.navigation.visualizarDepartamento}"
								actionListener="#{adminHandler.carregarDepartamento}">
								<f:attribute name="idDepartamento" value="#{dep.idDepartamento}" />

								<h:graphicImage value="../images/editar4.png"
									style="border:none;" title="Editar Departamento"
									alt="Editar Departamento" width="17" height="17"></h:graphicImage>
