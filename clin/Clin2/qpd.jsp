            ...
            <div id="main_content">
                ...
                <div id="page_content">
                    ...
                    <div align="right" id="salvoPor">
                        <h:outputText value="Salvo por: " rendered="#{fichaHandler.fichaQPD.salvoPor != null}" />
                        <h:outputText value="#{fichaHandler.fichaQPD.salvoPor.nome}" rendered="#{fichaHandler.fichaQPD.salvoPor != null}" />
                        <h:outputText value="Ficha não Salva" rendered="#{fichaHandler.fichaQPD.salvoPor == null}" />
                    </div>                   
                    ...
                    <h:form>
                        <div id="center_section">
                            ...
                            <h:inputTextarea id="qpd" value="#{fichaHandler.fichaQPD.queixaPrincipal}" style="margin-left:10px; width:100%; height:200px;"/>
                            <h2>Duração</h2>
                            <h:inputText styleClass="campoNormal" value="#{fichaHandler.fichaQPD.duracao}" maxlength="30"/>
                            <h2>Observação</h2>
                            <h:inputTextarea id="obs" value="#{fichaHandler.fichaQPD.observacao}" style="margin-left:10px; width:100%; height:200px;"/>
                            ...
                            <div align="center" style="margin-top:50px">
                                <h:panelGrid columns="3">
                                    ...
                                    <h:commandButton styleClass="bt_save" style="margin-right: 10px;" value="SALVAR" action="#{fichaHandler.salvarFichaQPD}" ></h:commandButton>
                                    <h:commandButton styleClass="botaoBuscar" value="ASSINAR"  action="#{fichaHandler.assinarFichaQDP}" disabled="#{!usuarioHandler.medico}"></h:commandButton>
                                </h:panelGrid>
                            </div>
                        </div>
                    </h:form>
