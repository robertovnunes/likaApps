                ...
                <div id="page_content">
                    ...
                    <div id="center_section">
                        ...
                        <h:form styleClass="frmstylizer">
                            ...
                            <h:panelGroup id="grupoCadastroAdm" rendered="#{usuarioHandler.administrador}">
                                <h:outputLabel styleClass="small" style="width: 150px">
                                    Login<font color="red">&#42;</font>
                                    <h:inputText styleClass="textfield" id="login"
                                ...
                                <h:outputLabel styleClass="small" style="width: 150px">
                                    ...
                                    <h:inputSecret styleClass="textfield" id="senha"
                                ...
                                <br />
                                <h:outputLabel styleClass="small" style="width: 150px">
                                    Confirmação da Senha<font color="red">&#42;</font>
                                    <h:inputSecret styleClass="textfield" id="confirmarSenha"
                            ...
                            <div align="center">
                                <h:panelGrid columns="2">
                                    ...
                                    <h:commandButton value="Salvar" styleClass="bt_add"
                                                     action="#{usuarioHandler.cadastrarUsuario}">
                                    </h:commandButton>
                                </h:panelGrid>
                            </div>
                    </h:form>
