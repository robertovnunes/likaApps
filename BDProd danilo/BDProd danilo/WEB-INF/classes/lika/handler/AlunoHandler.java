...
public class AlunoHandler {
	...
	private SelectItem[] tipoAlunos = { new SelectItem("IC", "IC"),
			new SelectItem("Estagiário", "Estagiário"),
			...
			new SelectItem("Pós-Doc", "Pós-Doc"),
			new SelectItem("Especialização", "Especialização"),
			...
			fc.addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_INFO,
							this.alunoAtual.getNome()
									+ " foi atualizado no banco como Pesquisador.", ""));
