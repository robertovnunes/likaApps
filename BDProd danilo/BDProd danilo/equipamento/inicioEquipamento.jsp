...
<f:view>
	...
	<div id="page"><h:form>
		...
		<ul>
			...
			<h2>Opções</h2>
			<ul>
				<li><h:commandLink value="Novo Equipamento"
					action="#{sessionHandler.navigation.novoEquipamento}"
					actionListener="#{equipamentoHandler.novoEquipamento}" /></li>
			</ul>
			</li>
		</ul>
		</div>
		...
		<div id="content"><a4j:region id="regiao">
			...
			<h:panelGroup id="campo">
				...
				<h:inputText id="textBuscaNome" style="width: 400px"
					value="#{equipamentoHandler.parametroConsulta}" />


				<a4j:commandButton id="botaoBuscar" value="Buscar"
					action="#{equipamentoHandler.consultar}" reRender="panel"
					onclick="this.disabled=true" oncomplete="this.disabled=false" />


			</h:panelGroup> <h:selectOneRadio value="#{equipamentoHandler.tipoSelecionado}">
				<f:selectItems value="#{equipamentoHandler.tiposDePesquisas}" />
				<a4j:support reRender="campo" event="onclick"
					action="#{equipamentoHandler.limparConsulta}" ajaxSingle="true" />
			</h:selectOneRadio></div>

			<a4j:outputPanel id="panel">

				<h:panelGroup rendered="#{empty equipamentoHandler.equipamentos }">
					<div id="nenhum" align="center" style="color: red;"><h:outputText
						value="Nenhum Equipamento econtrado. " /></div>
				</h:panelGroup>
				...
				<h:panelGroup
					rendered="#{not empty equipamentoHandler.equipamentos }">
					<div class="titulo" style="margin-left: 15px; margin-bottom: 15px">
					<h:outputText value="Equipamentos" /></div>

					<div style="margin-left: 10px;"><rich:dataTable
						id="tabelaResultado" value="#{equipamentoHandler.equipamentos}"
						var="equipamento" cellpadding="2" cellspacing="2"
						...
						<rich:column id="nome">
							...
							<div style="width: 420px"><h:outputText
								value="#{equipamento.nome}"></h:outputText></div>
						</rich:column>
						...
						<rich:column id="cpf">
							...
							<div style="width: 40px"><h:outputText
								value="#{equipamento.numeroTombamento}"></h:outputText></div>
						</rich:column>
						...
						<rich:column id="opcoes">
							...
							<h:commandLink
								action="#{sessionHandler.navigation.visualizarEquipamento}"
								actionListener="#{equipamentoHandler.carregarEquipamento}">
								<f:attribute name="idEquipamento"
									value="#{equipamento.idEquipamento}" />

								<h:graphicImage value="../images/editar4.png"
									style="border:none;" title="Editar Equipamento"
									alt="Editar Equipamento" width="17" height="17"></h:graphicImage>
