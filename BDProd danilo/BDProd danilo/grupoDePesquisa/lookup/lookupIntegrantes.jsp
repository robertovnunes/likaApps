...
<f:subview id="lookupIntegrantes">
	...
	<!-- ui-dialog -->
	<div id="dialogIntegrantes"
		title="Associar um Integrante ao Grupo de Pesquisa"><h:form
		styleClass="niceform">
		...
		<h:panelGroup>
			...
			<a4j:commandButton value="Buscar" reRender="novoIntegrante"
				action="#{pessoaHandler.consultar}" />
		</h:panelGroup></div>


		<a4j:outputPanel id="novoIntegrante">
			...
			<rich:dataTable id="tabelaResultadoIntegrante"
				value="#{pessoaHandler.pessoas}" var="pessoa" cellpadding="2"
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						ajaxSingle="true"
						onclick="jQuery('#dialogIntegrantes').dialog('close')" oncomplete="#{rich:component('dsIntegrante')}.last()"
						value="Selecionar" reRender="integrantes"
						actionListener="#{grupoHandler.adicionarIntegrante}">
						<f:attribute value="#{pessoa}" name="integrante" />
					</a4j:commandLink></div>
				</rich:column>
