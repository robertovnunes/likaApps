...
.myPosition {
	...
	<div id="container" style="margin-top: 30px;"><h:form
		...
		<h:commandButton value="Cadastro da Publicação"
			rendered="#{sessionHandler.navigation.mostrarVisualizarAnais}"
			actionListener="#{relatorioHandler.gerarCadastroAnais}">
		...
		<h:panelGroup
			...
			<div align="right" style="margin-top: 20px;"><h:commandButton
				value="Voltar" action="pesquisarAnais" /> <h:commandButton
				value="Editar" action="#{sessionHandler.navigation.editarAnais}">
		...
		<h:panelGroup
			rendered="#{sessionHandler.navigation.mostrarEditarAnais}">
			<div align="right" style="margin-top: 20px;"><h:commandButton
		...
		<f:subview id="editarAnais"
			rendered="#{sessionHandler.navigation.mostrarEditarAnais}">
			<jsp:include page="/anais/editarAnais.jsp"></jsp:include>
		</f:subview>

		<f:subview id="visualizarAnais"
			rendered="#{sessionHandler.navigation.mostrarVisualizarAnais}">
			<jsp:include page="/anais/visualizarAnais.jsp"></jsp:include>
		</f:subview>
