...
<f:view>
	...
	<div id="page"><h:form>
		...
		<ul>
			...
			<h2>Opções</h2>
			<ul>
				<li><h:commandLink value="Novo Periódico"
					action="#{sessionHandler.navigation.novoPeriodico}"
			...
			<a4j:outputPanel id="panel">
				...
				<h:panelGroup rendered="#{empty publicacaoHandler.publicacoes }">
					<div id="nenhum" align="center" style="color: red;"><h:outputText
						value="Nenhum Periódico econtrado. " /></div>
				</h:panelGroup>
				...
				<h:panelGroup rendered="#{not empty publicacaoHandler.publicacoes }">
					...
					<h:outputText value="Periódicos" /></div>
					...
					<div style="margin-left: 10px;"><rich:dataTable
						...
						<rich:column id="opcoes">
							...
							<h:commandLink
								action="#{sessionHandler.navigation.visualizarPeriodico}"
