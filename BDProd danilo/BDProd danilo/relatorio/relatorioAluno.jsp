...
.erro {
		...
		<h:form styleClass="niceform" prependId="false">
			...
			<div align="center"><h:panelGrid columns="7">
				<a4j:outputPanel id="panelTipo">
					...
					<br />
					<h:selectOneMenu id="tipo" value="#{relatorioAlunoHandler.tipo}"
						>
				...
				<a4j:outputPanel id="panelSituacao">
					...
					<br />
					<h:selectOneMenu value="#{relatorioAlunoHandler.situacao}"
						immediate="true"
						>
				...
				<h:panelGroup>
					...
					<h:inputText size="5" maxlength="4"
						...
						value="#{relatorioAlunoHandler.dataInicio}"></h:inputText>
					<h:outputLabel value="à" style="margin-right: 2px;"></h:outputLabel>
					<h:inputText size="5" maxlength="4"
						onkeypress="mascara(this,soNumeros)"
						value="#{relatorioAlunoHandler.dataFim}"></h:inputText>
				</h:panelGroup>
				...
				<h:panelGroup>
					...
					<br />
					<h:selectOneMenu value="#{relatorioAlunoHandler.tipoFiltro}"
						immediate="true">
						...
						<a4j:support event="onchange"
							action="#{relatorioAlunoHandler.tipoFiltroChanged}"
			...
			<h:panelGroup id="panels">
				<h:panelGroup id="panelOrientador"
					rendered="#{relatorioAlunoHandler.tipoFiltro == 'Por Orientador'}">
					<br />
					<div style="margin-left: 255px;"><h:outputLabel
						value="Nome do Orientador:" /> <br />
					<h:inputText value="#{relatorioAlunoHandler.pesquisador.nome}"
			...
			<div align="center"><h:commandButton value="Gerar Relatório"
				actionListener="#{relatorioAlunoHandler.gerarDadosAluno}">
	...
	<div style="margin-top: 150px;"><f:subview id="lookupOrientador">
		<jsp:include
			page="/relatorio/lookupRelatorioAlunos/lookupOrientador.jsp"></jsp:include>
	</f:subview></div>
	</body>
	</html>
</f:view>
