...
<body>
<f:subview id="lookupPessoa">




	<!-- ui-dialog -->
	<div id="dialogResponsavel" title="Associar Pessoa ao Usuário"><h:form
		styleClass="niceform">
		...
		<a4j:outputPanel id="novoOrientador">
			...
			<rich:dataTable id="tabelaResultadoOrientador"
				value="#{pesquisadorHandler.pesquisadoresListados}"
				var="pesquisador" cellpadding="2" cellspacing="2"
				style="width:580px" rows="5" styleClass="mytable"
				rendered="#{!empty pesquisadorHandler.pesquisadoresListados }">
				<rich:column id="nome">
					<f:facet name="header">
					...
					<div style="width: 450px"><h:outputText
						value="#{pesquisador.nome}"></h:outputText></div>
				</rich:column>
				...
				<rich:column id="opcoes">
					...
					<div style="width: 60px" align="center"><a4j:commandLink
						...
						actionListener="#{usuarioHandler.selecionarPesquisador}">
						<f:attribute value="#{pesquisador}" name="pesquisador" />
					</a4j:commandLink></div>
				</rich:column>
